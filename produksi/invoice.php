...
<html lang="en">
    ...
    <table id="export" class="table table-striped" style="width:100%">
        ...
        <tbody>
            ...
            include "koneksi/koneksi.php";
            $no = 1;
            $tampil = mysqli_query($koneksi, "SELECT * FROM invoice ORDER BY id_invoice DESC");
                ...
                <div class='modal fade' id='modalubah".$no."' data-bs-backdrop='static' data-bs-keyboard='false' tabindex='-1' aria-labelledby='staticBackdropLabel' aria-hidden='true'>
                    <div class='modal-dialog'>
                        <div class='modal-content'>
                            ...
                            <form method='POST' action='aksi/aksi_invoice.php'>
                                <input type='hidden' name='id_invoice' value='".$data['id_invoice']."'>
                                <div class='modal-body'>
                                    <div class='mb-3'>
                                        <label class='form-label'>Issuedate</label>
                                        <input type='date' class='form-control' name='issuedate' value='".$data['issuedate']."' placeholder='Masukkan Tanggal'>
                                    </div>
                                    <div class='mb-3'>
                                        <label class='form-label'>Number</label>
                                        <input type='number' class='form-control' name='number' value='".$data['number']."' placeholder='Masukkan Nama Produk'>
                                    </div>
                                    <div class='mb-3'>
                                        <label class='form-label'>Duedate</label>
                                        <input type='date' class='form-control' name='duedate' value='".$data['duedate']."' placeholder='Masukkan Jumlah'>
                                    </div>
                                    <div class='mb-3'>
                            ...
                            <form method='POST' action='aksi/aksi_invoice.php'>
                                ...
                                <div class='modal-body'>
                                    <h5> Dengan menghapus data ini anda akan menghapus data dari daftar!<br><br>
                                        <span class='text-danger'>".$data['id_invoice']."</span>
                                    </h5>
                                </div>
                                <div class='modal-footer'>
                        ...
                        <div class="modal-content">
                            ...
                            <form method="POST" action="aksi/aksi_invoice.php">
                                <div class="modal-body">
                                    <div class="mb-3">
                                        <label class="form-label">Issuedate</label>
                                        <input type="date" class="form-control" name="issuedate" placeholder="Masukkan Issuedate">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Number</label>
                                        <input type="text" class="form-control" name="number" placeholder="Masukkan Number">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Duedate</label>
                                        <input type="date" class="form-control" name="duedate" placeholder="Masukkan Duedate">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Total</label>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select" name="tstatus">
                                            <option value="Paid">Layak</option>
                                            <option value="Unpaid">Belum Layak</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="modal-footer">
