...
<html lang="en">
        ...
        <div id="layoutSidenav">
            ...
            <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Rencana Produksi</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="index.html">Dashboard</a></li>
                            <li class="breadcrumb-item active">Rencana Produksi</li>
                        </ol>
    ...
    <table id="export" class="table table-striped" style="width:100%">
        ...
        <tbody>
            ...
            include "koneksi/koneksi.php";
            $no = 1;
            $tampil = mysqli_query($koneksi, "SELECT * FROM trencana ORDER BY id_rencana DESC");
                ...
                <div class='modal fade' id='modalubah".$no."' data-bs-backdrop='static' data-bs-keyboard='false' tabindex='-1' aria-labelledby='staticBackdropLabel' aria-hidden='true'>
                    <div class='modal-dialog'>
                        <div class='modal-content'>
                            ...
                            <form method='POST' action='aksi/aksi_rencana.php'>
                                ...
                                <div class='modal-body'>
                                    ...
                                    <div class='mb-3'>
                                        ...
                                        <input type='text' class='form-control' name='tharga_jual' value='".$data['harga_jual']."' placeholder='Masukkan Harga Jual  Produk'>
                                    </div>
                                </div>
                        ...
                        <div class="modal-content">
                            ...
                            <form method="POST" action="aksi/aksi_rencana.php">
                                <div class="modal-body">
                                    ...
                                    <div class="mb-3">
                                        <label class="form-label">Harga Jual</label>
                                        <input type="text" class="form-control" name="tharga_jual" placeholder="Masukkan Harga Jual">
                                    </div>
                                </div>
                                <div class="modal-footer">
