        ...
        <div id="layoutSidenav">
            ...
            <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">capital_statement</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="index.html">Dashboard</a></li>
                            <li class="breadcrumb-item active">capital_statement</li>
                        </ol>
    ...
    <table id="export" class="table table-striped" style="width:100%">
        <thead>
            <tr>
                ...
                <th>Owner Drawings</th>
                <th>Owner Investmen</th>
                <th>Aksi</th>
        ...
        <tbody>
            ...
            include "koneksi/koneksi.php";
            $no = 1;
            $tampil = mysqli_query($koneksi, "SELECT * FROM capital_statement ORDER BY id_capital_statement DESC");
            while ($data = mysqli_fetch_array($tampil)) {
                ...
                <td>".$data['owner_drawings']."</td>
                <td>".$data['owner_investmen']."</td>
                ...
                <div class='modal fade' id='modalubah".$no."' data-bs-backdrop='static' data-bs-keyboard='false' tabindex='-1' aria-labelledby='staticBackdropLabel' aria-hidden='true'>
                    <div class='modal-dialog'>
                        <div class='modal-content'>
                            ...
                            <form method='POST' action='aksi/aksi_capital_statement.php'>
                                <input type='hidden' name='id_capital_statement' value='".$data['id_capital_statement']."'>
                                <div class='modal-body'>
                                    <div class='mb-3'>
                                        <label class='form-label'>ID Account</label>
                                        <input type='int' class='form-control' name='id_account' value='".$data['id_account']."' placeholder='Masukkan ID Account'>
                                    </div>
                                    <div class='mb-3'>
                                        <label class='form-label'>Tanggal Transaksi</label>
                                        <input type='date' class='form-control' name='balance_date' value='".$data['balance_date']."' placeholder='Masukkan Tanggal'>
                                    </div>
                                    <div class='mb-3'>
                                        <label class='form-label'>Saldo Awal</label>
                                        <input type='decimal' class='form-control' name='opening_balance' value='".$data['opening_balance']."' placeholder='Masukkan Saldo Awal'>
                                    </div>
                                    <div class='mb-3'>
                                        <label class='form-label'>Saldo Akhir</label>
                                        <input type='decimal' class='form-control' name='closing_balance' value='".$data['closing_balance']."' placeholder='Masukkan Saldo Akhir'>
                                    </div>
                                    <div class='mb-3'>
                                        <label class='form-label'>Pendapatan Bersih</label>
                                        <input type='decimal' class='form-control' name='net_income' value='".$data['net_income']."' placeholder='Masukkan Pendapatan Bersih'>
                                    </div>
                                    <div class='mb-3'>
                                        <label class='form-label'>Owner Drawings</label>
                                        <input type='decimal' class='form-control' name='owner_drawings' value='".$data['owner_drawings']."' placeholder='Masukkan Jumlah'>
                                    </div>
                                    <div class='mb-3'>
                                        <label class='form-label'>Owner Investment</label>
                                        <input type='decimal' class='form-control' name='owner_investmen' value='".$data['owner_investmen']."' placeholder='Masukkan Jumlah'>
                                    </div>
                                </div>
                            ...
                            <form method='POST' action='aksi/aksi_capital_statement.php'>
                                ...
                                <div class='modal-body'>
                                    <h5> Dengan menghapus data ini anda akan menghapus data dari daftar!<br><br>
                                        <span class='text-danger'>".$data['id_capital_statement']."</span>
                                    </h5>
                                </div>
                                <div class='modal-footer'>
                        ...
                        <div class="modal-content">
                            ...
                            <form method="POST" action="aksi/aksi_capital_statement.php">
                                <div class="modal-body">
                                    <div class="mb-3">
                                        <label class="form-label">ID Account</label>
                                        <input type="int" class="form-control" name="id_account" placeholder="Masukkan Amount">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Tanggal Transaksi</label>
                                        <input type="date" class="form-control" name="balance_date" placeholder="Masukkan Tanggal Transaksi">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Saldo Awal</label>
                                        <input type="decimal" class="form-control" name="opening_balance" placeholder="Masukkan Saldo Awal">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Saldo Akhir</label>
                                        <input type="decimal" class="form-control" name="closing_balance" placeholder="Masukkan Saldo Akhir">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Pendapatan Bersih</label>
                                        <input type="decimal" class="form-control" name="net_income" placeholder="Masukkan Pendapatan Bersih">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Owner Drawings</label>
                                        <input type="decimal" class="form-control" name="owner_drawings" placeholder="Masukkan Jumlah">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Owner Investment</label>
                                        <input type="decimal" class="form-control" name="owner_investmen" placeholder="Masukkan Jumlah">
                                    </div>
