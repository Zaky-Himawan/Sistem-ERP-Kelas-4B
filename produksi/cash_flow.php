...
<html lang="en">
        ...
        <div id="layoutSidenav">
            ...
            <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">cash_flow</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="index.html">Dashboard</a></li>
                            <li class="breadcrumb-item active">cash_flow</li>
                        </ol>
    ...
    <table id="export" class="table table-striped" style="width:100%">
        ...
        <tbody>
            ...
            include "koneksi/koneksi.php";
            $no = 1;
            $tampil = mysqli_query($koneksi, "SELECT * FROM cash_flow ORDER BY id_cash_flow DESC");
                ...
                <div class='modal fade' id='modalubah".$no."' data-bs-backdrop='static' data-bs-keyboard='false' tabindex='-1' aria-labelledby='staticBackdropLabel' aria-hidden='true'>
                    <div class='modal-dialog'>
                        <div class='modal-content'>
                            ...
                            <form method='POST' action='aksi/aksi_cash_flow.php'>
                                <input type='hidden' name='id_cash_flow' value='".$data['id_cash_flow']."'>
                                <div class='modal-body'>
                                    ...
                                    <div class='mb-3'>
                                        ...
                                        <input type='decimal' class='form-control' name='amount' value='".$data['amount']."' placeholder='Masukkan Jumlah'>
                                    </div>
                                    <div class='mb-3'>
                                          <label class='form-label'>Metode Pembayaran</label>
                                        <input type='varchar' class='form-control' name='type' value='".$data['type']."' placeholder='Masukkan Metode Pembayaran'>
                                    </div>
                                    <div class='mb-3'>
                                        <label class='form-label'>Description</label>
                                        <input type='text' class='form-control' name='description' value='".$data['description']."' placeholder='Masukkan Deskripsi'>
                                    </div>
                                    <div class='mb-3'>
                                          <label class='form-label'>Created at</label>
                                        <input type='date' class='form-control' name='created' value='".$data['created']."' placeholder='Masukkan Created at'>
                                    </div>
                                    <div class='mb-3'>
                                        <label class='form-label'>Description</label>
                                        <input type='date' class='form-control' name='updated' value='".$data['updated']."' placeholder='Masukkan Updated at'>
                                    </div>
                                </div>
                            ...
                            <form method='POST' action='aksi/aksi_cash_flow.php'>
                                ...
                                <div class='modal-body'>
                                    <h5> Dengan menghapus data ini anda akan menghapus data dari daftar!<br><br>
                                        <span class='text-danger'>".$data['id_cash_flow']."</span>
                                    </h5>
                                </div>
                                <div class='modal-footer'>
                        ...
                        <div class="modal-content">
                            ...
                            <form method="POST" action="aksi/aksi_cash_flow.php">
                                <div class="modal-body">
                                    ...
                                    <div class="mb-3">
                                        <label class="form-label">Amount</label>
                                        <input type="decimal" class="form-control" name="amount" placeholder="Masukkan Jumlah">
                                    </div>
                                    <div class="mb-3">
                                    <label class="form-label">Metode Pembayaran</label>
                                    ...
                                    <div class="mb-3">
                                        <label class="form-label">Created at</label>
                                        <input type="date" class="form-control" name="created" placeholder="Masukkan Created at">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Updated at</label>
                                        <input type="date" class="form-control" name="updated" placeholder="Masukkan Updated at">
                                    </div>
                                </div>
                                <div class="modal-footer">
