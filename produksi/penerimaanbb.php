...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Penerimaan Bahan Baku</h1>
                        <div class="card mb-4">
                        <div class="card-header"><button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal">
                            ...
                            <a href="laporanterimabb.php" class="btn btn-info">Laporan Penerimaan</a>
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <?php
                                        $ambildata = mysqli_query($conn, "select * from penerimaan_bb m, bahan_baku s where s.id_bahanbaku = m.id_bahanbaku");
                                        while($data=mysqli_fetch_array($ambildata)){
                                            $idbahan = $data['id_bahanbaku'];
                                            $idpenerimaan = $data['id_penerimaan_bahan_baku'];
                                        ...
                                        <div class="modal fade" id="update<?=$idpenerimaan;?>">
                                            ...
                                            <button type="submit" class="btn btn-primary" name="updatepenerimaanbb">Submit</button>
                                            </div>
                                            </form>
                                            </div>
                                            </div>
                                        ...
                                        <div class="modal fade" id="delete<?=$idpenerimaan;?>">
                                            ...
                                            <br>
                                            <br>
                                            <button type="submit" class="btn btn-danger" name="hapuspenerimaanbb">Hapus</button>
                                            </div>
                                            </form>
                                            </div>
                                            </div>
        ...
        <script src="https://cdn.jsdelivr.net/npm/bootstrap@4.6.2/dist/js/bootstrap.bundle.min.js"></script>
            ...
            <div class="modal-header">
            <h4 class="modal-title">Penerimaan Bahan Baku</h4>
            <button type="button" class="close" data-dismiss="modal">&times;</button>
            </div>
            ...
            <br>
            <button type="submit" class="btn btn-primary" name="Terimabb">Submit</button>
            </div>
            </form>
        </div>
        </div>
