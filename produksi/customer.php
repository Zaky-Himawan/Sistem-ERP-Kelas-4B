                ...
                <div class='modal fade' id='modalubah".$no."' data-bs-backdrop='static' data-bs-keyboard='false' tabindex='-1' aria-labelledby='staticBackdropLabel' aria-hidden='true'>
                    <div class='modal-dialog'>
                        <div class='modal-content'>
                            ...
                            <form method='POST' action='aksi/aksi_customer.php'>
                                <input type='hidden' name='id_customer' value='".$data['id_customer']."'>
                                <div class='modal-body'>
                                    <div class='mb-3'>
                                        <label class='form-label'>Type Customer</label>
                                        <input type='text' class='form-control' name='type_customer' value='".$data['type_customer']."' placeholder='Masukkan typecustomer'>
                                    </div>
                                    <div class='mb-3'>
                                    ...
                                    <div class='mb-3'>
                                        ...
                                        <input type='text' class='form-control' name='address' value='".$data['address']."' placeholder='Masukkan address'>
                                    </div>
                                    <div class='mb-3'>
                                        <label class='form-label'>phone</label>
                                        <input type='text' class='form-control' name='phone' value='".$data['phone']."' placeholder='Masukkan phone'>
                                    </div>
                                    <div class='mb-3'>
                            ...
                            <form method='POST' action='aksi/aksi_customer.php'>
                                ...
                                <div class='modal-body'>
                                    <h5> Dengan menghapus data ini anda akan menghapus data dari daftar!<br><br>
                                        <span class='text-danger'>".$data['id_customer']."</span>
                                    </h5>
                                </div>
                                <div class='modal-footer'>
                        ...
                        <div class="modal-content">
                            ...
                            <form method="POST" action="aksi/aksi_customer.php">
                                <div class="modal-body">
                                    <div class="mb-3">
                                        <label class="form-label">Type Customer</label>
                                        <input type="text" class="form-control" name="type_customer" placeholder="Masukkan Type Customer">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Name Customer</label>
                                        <input type="text" class="form-control" name="name" placeholder="Masukkan name customer">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">address Customer</label>
                                        <input type="text" class="form-control" name="address" placeholder="Masukkan address customer">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">phone Customer</label>
                                        <input type="text" class="form-control" name="phone" placeholder="Masukkan phone">
                                    </div>
                                    <div class="mb-3">
