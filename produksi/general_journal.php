...
<html lang="en">
        ...
        <div id="layoutSidenav">
            ...
            <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">general_journal</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="index.html">Dashboard</a></li>
                            <li class="breadcrumb-item active">general_journal</li>
                        </ol>
    ...
    <table id="export" class="table table-striped" style="width:100%">
        ...
        <tbody>
            ...
            include "koneksi/koneksi.php";
            $no = 1;
            $tampil = mysqli_query($koneksi, "SELECT * FROM general_journal ORDER BY id_general_journal DESC");
                ...
                <div class='modal fade' id='modalubah".$no."' data-bs-backdrop='static' data-bs-keyboard='false' tabindex='-1' aria-labelledby='staticBackdropLabel' aria-hidden='true'>
                    <div class='modal-dialog'>
                        <div class='modal-content'>
                            ...
                            <form method='POST' action='aksi/aksi_general_journal.php'>
                                <input type='hidden' name='id_general_journal' value='".$data['id_general_journal']."'>
                                <div class='modal-body'>
                                    ...
                                    <div class='mb-3'>
                                        ...
                                        <input type='date' class='form-control' name='date' value='".$data['date']."' placeholder='Masukkan Tanggal'>
                                    </div>
                                    <div class='mb-3'>
                                        <label class='form-label'>Deskripsi</label>
                                        <input type='varchar' class='form-control' name='description' value='".$data['description']."' placeholder='Masukkan Deskripsi'>
                                    </div>
                                    <div class='mb-3'>
                                        <label class='form-label'>Debit</label>
                                        <input type='decimal' class='form-control' name='debit' value='".$data['debit']."' placeholder='Masukkan Jumlah'>
                                    </div>
                                    <div class='mb-3'>
                                        <label class='form-label'>Kredit</label>
                                        <input type='decimal' class='form-control' name='credit' value='".$data['credit']."' placeholder='Masukkan Jumlah'>
                                    </div>
                                    <div class='mb-3'>
                                        <label class='form-label'>Tanggal Dibuat</label>
                                        <input type='date' class='form-control' name='created_at' value='".$data['created_at']."' placeholder='Masukkan Tanggal'>
                                    </div>
                                    <div class='mb-3'>
                                        <label class='form-label'>Tanggal Diubah</label>
                                        <input type='date' class='form-control' name='updated_at' value='".$data['updated_at']."' placeholder='Masukkan Tanggal'>
                                    </div>
                                </div>
                            ...
                            <form method='POST' action='aksi/aksi_general_journal.php'>
                                ...
                                <div class='modal-body'>
                                    <h5> Dengan menghapus data ini anda akan menghapus data dari daftar!<br><br>
                                        <span class='text-danger'>".$data['id_general_journal']."</span>
                                    </h5>
                                </div>
                                <div class='modal-footer'>
                        ...
                        <div class="modal-content">
                            ...
                            <form method="POST" action="aksi/aksi_general_journal.php">
                                <div class="modal-body">
                                    ...
                                    <div class="mb-3">
                                        <label class="form-label">Tanggal Transaksi</label>
                                        <input type="date" class="form-control" name="date" placeholder="Masukkan Tanggal Transaksi">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Deskripsi</label>
                                        <input type="varchar" class="form-control" name="description" placeholder="Masukkan Deskripsi">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Debit</label>
                                        <input type="decimal" class="form-control" name="debit" placeholder="Masukkan Jumlah">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Kredit</label>
                                        <input type="decimal" class="form-control" name="credit" placeholder="Masukkan Jumlah">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Tanggal Dibuat</label>
                                        <input type="date" class="form-control" name="created_at" placeholder="Masukkan Tanggal">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Tanggal Diubah</label>
                                        <input type="date" class="form-control" name="updated_at" placeholder="Masukkan Tanggal">
                                    </div>
