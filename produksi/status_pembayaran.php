...
<html lang="en">
        ...
        <div id="layoutSidenav">
            ...
            <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">status_pembayaran</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="index.html">Dashboard</a></li>
                            <li class="breadcrumb-item active">status_pembayaran</li>
                        </ol>
    ...
    <table id="export" class="table table-striped" style="width:100%">
        ...
        <tbody>
            ...
            include "koneksi/koneksi.php";
            $no = 1;
            $tampil = mysqli_query($koneksi, "SELECT * FROM status_pembayaran ORDER BY id_status_pembayaran DESC");
                ...
                <div class='modal fade' id='modalubah".$no."' data-bs-backdrop='static' data-bs-keyboard='false' tabindex='-1' aria-labelledby='staticBackdropLabel' aria-hidden='true'>
                    <div class='modal-dialog'>
                        <div class='modal-content'>
                            ...
                            <form method='POST' action='aksi/aksi_status_pembayaran.php'>
                                <input type='hidden' name='id_status_pembayaran' value='".$data['id_status_pembayaran']."'>
                                <div class='modal-body'>
                                    <div class='mb-3'>
                                        <label class='form-label'>ID Order</label>
                                        <input type='int' class='form-control' name='id_order' value='".$data['id_order']."' placeholder='Masukkan ID Order'>
                                    </div>
                                    <div class='mb-3'>
                                        <label class='form-label'>Tanggal</label>
                                        <input type='date' class='form-control' name='purchase_date' value='".$data['purchase_date']."' placeholder='Masukkan Tanggal'>
                                    </div>
                                    <div class='mb-3'>
                                        <label class='form-label'>Amount</label>
                                        <input type='decimal' class='form-control' name='total_amount' value='".$data['total_amount']."' placeholder='Masukkan Jumlah'>
                                    </div>
                                </div>
                            ...
                            <form method='POST' action='aksi/aksi_status_pembayaran.php'>
                                ...
                                <div class='modal-body'>
                                    <h5> Dengan menghapus data ini anda akan menghapus data dari daftar!<br><br>
                                        <span class='text-danger'>".$data['id_status_pembayaran']."</span>
                                    </h5>
                                </div>
                                <div class='modal-footer'>
                        ...
                        <div class="modal-content">
                            ...
                            <form method="POST" action="aksi/aksi_status_pembayaran.php">
                                <div class="modal-body">
                                    <div class="mb-3">
                                        <label class="form-label">ID Order</label>
                                        <input type="int" class="form-control" name="id_order" placeholder="Masukkan ID Order">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Tanggal</label>
                                        <input type="date" class="form-control" name="purchase_date" placeholder="Masukkan Tanggal">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Amount</label>
                                        <input type="decimal" class="form-control" name="total_amount" placeholder="Masukkan Amount">
                                    </div>
                                </div>
                                <div class="modal-footer">
