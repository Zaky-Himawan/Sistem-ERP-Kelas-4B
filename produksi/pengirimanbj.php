...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <a class="navbar-brand ps-3">PPT Petrokimia Gresik</a>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Pengiriman Barang Jadi</h1>
                        <div class="card mb-4">
                        <div class="card-header"><button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal">
                            ...
                            <a href="laporankirimbj.php" class="btn btn-info">Laporan Pengiriman</a>
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <?php
                                        $ambildata = mysqli_query($conn, "select * from pengiriman_bj k, barang_jadi s where s.id_barangjadi = k.id_barangjadi");
                                        while($data=mysqli_fetch_array($ambildata)){
                                            $idpengiriman=$data['id_pengiriman_barang_jadi'];
                                        ...
                                        <div class="modal fade" id="update<?=$idpengiriman;?>">
                                            ...
                                            <button type="submit" class="btn btn-primary" name="updatepengirimanbj">Submit</button>
                                            </div>
                                            </form>
                                            </div>
                                            </div>
                                        ...
                                        <div class="modal fade" id="delete<?=$idpengiriman;?>">
                                            ...
                                            <br>
                                            <br>
                                            <button type="submit" class="btn btn-danger" name="hapuspengirimanbj">Hapus</button>
                                            </div>
                                            </form>
                                            </div>
                                            </div>
        ...
        <script src="https://cdn.jsdelivr.net/npm/bootstrap@4.6.2/dist/js/bootstrap.bundle.min.js"></script>
            ...
            <div class="modal-header">
            <h4 class="modal-title">Pengiriman Barang Jadi</h4>
            <button type="button" class="close" data-dismiss="modal">&times;</button>
            </div>
            ...
            <br>
            <button type="submit" class="btn btn-primary" name="Kirimbj">Submit</button>
            </div>
            </form>
        </div>
        </div>
