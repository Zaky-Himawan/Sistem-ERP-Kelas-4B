...
<html lang="en">
        ...
        <div id="layoutSidenav">
            ...
            <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Perancangan Produk</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="index.html">Dashboard</a></li>
                            <li class="breadcrumb-item active">Perancangan Produk</li>
                        </ol>
    ...
    <table id="export" class="table table-striped" style="width:100%">
        ...
        <tbody>
            ...
            include "koneksi/koneksi.php";
            $no = 1;
            $tampil = mysqli_query($koneksi, "SELECT * FROM tperancangan ORDER BY id_perancangan DESC");
                ...
                <div class='modal fade' id='modalubah".$no."' data-bs-backdrop='static' data-bs-keyboard='false' tabindex='-1' aria-labelledby='staticBackdropLabel' aria-hidden='true'>
                    <div class='modal-dialog'>
                        <div class='modal-content'>
                            ...
                            <form method='POST' action='aksi/aksi_perancangan.php'>
                                <input type='hidden' name='id_perancangan' value='".$data['id_perancangan']."'>
                                <div class='modal-body'>
                                    <div class='mb-3'>
                                        <label class='form-label'>Tanggal</label>
                                        <input type='date' class='form-control' name='ttanggal' value='".$data['tanggal']."' placeholder='Masukkan Tanggal'>
                                    </div>
                                    <div class='mb-3'>
                                    ...
                                    <div class='mb-3'>
                                        ...
                                        <input type='text' class='form-control' name='tdeskripsi' value='".$data['deskripsi']."' placeholder='Masukkan Deskripsi Perancangan Produk'>
                                    </div>
                                </div>
            ...
            ?>
                ...
                <div class="modal fade" id="modaldaftar" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title fs-5" id="staticBackdropLabel">Form Untuk Mendaftar</h5>
                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                            </div>
                            <form method="POST" action="aksi/aksi_perancangan.php">
                                <div class="modal-body">
                                    ...
                                    <div class="mb-3">
                                        <label class="form-label">Deskripsi</label>
                                        <input type="text" class="form-control" name="tdeskripsi" placeholder="Masukkan Deskripsi Perancangan Produk">
                                    </div>
                                </div>
                                <div class="modal-footer">
