...
<html lang="en">
        ...
        <div id="layoutSidenav">
            ...
            <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">balance_report</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="index.html">Dashboard</a></li>
                            <li class="breadcrumb-item active">balance_report</li>
                        </ol>
    ...
    <table id="export" class="table table-striped" style="width:100%">
        ...
        <tbody>
            ...
            include "koneksi/koneksi.php";
            $no = 1;
            $tampil = mysqli_query($koneksi, "SELECT * FROM balance_report ORDER BY id_balance_report DESC");
                ...
                <div class='modal fade' id='modalubah".$no."' data-bs-backdrop='static' data-bs-keyboard='false' tabindex='-1' aria-labelledby='staticBackdropLabel' aria-hidden='true'>
                    <div class='modal-dialog'>
                        <div class='modal-content'>
                            ...
                            <form method='POST' action='aksi/aksi_balance_report.php'>
                                <input type='hidden' name='id_balance_report' value='".$data['id_balance_report']."'>
                                <div class='modal-body'>
                                    <div class='mb-3'>
                                        <label class='form-label'>Tanggal</label>
                                        <input type='date' class='form-control' name='report_date' value='".$data['report_date']."' placeholder='Masukkan Tanggal'>
                                    </div>
                                    <div class='mb-3'>
                                        <label class='form-label'>Total Assets/label>
                                        <input type='decimal' class='form-control' name='total_assets' value='".$data['total_assets']."' placeholder='Masukkan Total'>
                                    </div>
                                    <div class='mb-3'>
                                        <label class='form-label'>Total Liabilities</label>
                                        <input type='decimal' class='form-control' name='total_liabilities' value='".$data['total_liabilities']."' placeholder='Masukkan Total'>
                                    </div>
                                     <div class='mb-3'>
                                        <label class='form-label'>Total Equity</label>
                                        <input type='decimal' class='form-control' name='total_equity' value='".$data['total_equity']."' placeholder='Masukkan Total'>
                                    </div>
                                </div>
                            ...
                            <form method='POST' action='aksi/aksi_balance_report.php'>
                                ...
                                <div class='modal-body'>
                                    <h5> Dengan menghapus data ini anda akan menghapus data dari daftar!<br><br>
                                        <span class='text-danger'>".$data['id_balance_report']."</span>
                                    </h5>
                                </div>
                                <div class='modal-footer'>
                        ...
                        <div class="modal-content">
                            ...
                            <form method="POST" action="aksi/aksi_balance_report.php">
                                <div class="modal-body">
                                    <div class="mb-3">
                                        <label class="form-label">Tanggal</label>
                                        <input type="date" class="form-control" name="report_date" placeholder="Masukkan Tanggal">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Total Assets</label>
                                        <input type="decimal" class="form-control" name="total_assets" placeholder="Masukkan Total">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Total Liabilities</label>
                                        <input type="decimal" class="form-control" name="total_liabilities" placeholder="Masukkan Total">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Total Equity</label>
                                        <input type="decimal" class="form-control" name="total_equity" placeholder="Masukkan Total">
                                    </div>
                                </div>
                                <div class="modal-footer">
