...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <a class="navbar-brand ps-3">PT GUDANG GARAM</a>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Pengiriman Bahan Baku</h1>
                        <div class="card mb-4">
                        <div class="card-header"><button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal">
                                Input Pengiriman Bahan Baku
                            </button>
                            <a href="laporankirimbb.php" class="btn btn-info">Laporan Pengiriman</a>
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <?php
                                        ...
                                        <tr>
                                            ...
                                            <td><?=$total;?></td>
                                            <td>
                                                <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#update<?=$idpengiriman;?>">
                                                    Update
                                                </button>
                                                <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#delete<?=$idpengiriman;?>">
                                                    Delete
                                                </button>
                                            </td> 
                                        </tr>
                                        ...
                                        <!--Update-->
                                        <div class="modal fade" id="update<?=$idpengiriman;?>">
                                            <div class="modal-dialog">
                                            <div class="modal-content">
                                        
                                            <div class="modal-header">
                                            <h4 class="modal-title">Update Bahan Baku</h4>
                                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                                            </div>
                                            
                                            <form method="post">
                                            <div class="modal-body">
                                            <input type="text" name="nama_bahanbaku" value="<?=$namabahan;?>" class="form-control" autocomplete="off" required>
                                            <br>
                                            ...
                                            <input type="hidden" name="idpengiriman" value="<?=$idpengiriman;?>">
                                            <button type="submit" class="btn btn-primary" name="updatepengirimanbb">Submit</button>
                                            </div>
                                            </form>
                                            </div>
                                            </div>
                                        ...
                                        <!--Delete-->
                                        <div class="modal fade" id="delete<?=$idpengiriman;?>">
                                            <div class="modal-dialog">
                                            <div class="modal-content">
                                            ...
                                            <form method="post">
                                            <div class="modal-body">
                                            Apakah anda yakin ingin menghapus <?=$namabahan;?> ?
                                            <input type="hidden" name="idbahan" value="<?=$idbahan;?>">
                                            <input type="hidden" name="totalnya" value="<?=$total;?>">
                                            <input type="hidden" name="idpengiriman" value="<?=$idpengiriman;?>">
                                            <br>
                                            <br>
                                            <button type="submit" class="btn btn-danger" name="hapuspengirimanbb">Hapus</button>
                                            </div>
                                            </form>
                                            </div>
                                            </div>
        ...
        <script src="https://cdn.jsdelivr.net/npm/bootstrap@4.6.2/dist/js/bootstrap.bundle.min.js"></script>
            ...
            <div class="modal-header">
            <h4 class="modal-title">Pengiriman Bahan Baku</h4>
            <button type="button" class="close" data-dismiss="modal">&times;</button>
            </div>
            ...
            <select name="bahan" class="form-control">
                <?php
                    $ambildata = mysqli_query($conn, "select * from bahan_baku");
                    while($fetcharray = mysqli_fetch_array($ambildata)){
                        $namabahan = $fetcharray['nama_bahanbaku'];
                        $idbahan = $fetcharray['id_bahanbaku'];
                ?>
            ...
            <br>
            <button type="submit" class="btn btn-primary" name="Kirimbb">Submit</button>
            </div>
            </form>
        </div>
        </div>
