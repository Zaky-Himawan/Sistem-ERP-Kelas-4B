<?php
// Koneksi ke database
include "koneksi/koneksi.php"; // Sesuaikan path koneksi sesuai struktur folder Anda
?>
        ...
        <div id="layoutSidenav">
            ...
            <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Finansial Report</h1>
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $query = "INSERT INTO finansial_report (category, item_name, amount, date) 
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        <?php
                        $result = mysqli_query($koneksi, "SELECT item_name, amount FROM finansial_report WHERE category='Assets'");
                        $total_assets = 0;
            ...
            <div class="col-md-4">
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        <?php
                        $result = mysqli_query($koneksi, "SELECT item_name, amount FROM finansial_report WHERE category='Liabilities'");
                        $total_liabilities = 0;
                        while ($row = mysqli_fetch_assoc($result)) {
                            echo "<tr>
                                    <td>{$row['item_name']}</td>
            ...
            <div class="col-md-4">
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        <?php
                        $result = mysqli_query($koneksi, "SELECT item_name, amount FROM finansial_report WHERE category='Equity'");
                        $total_equity = 0;
                        while ($row = mysqli_fetch_assoc($result)) {
                            echo "<tr>
                                    <td>{$row['item_name']}</td>
