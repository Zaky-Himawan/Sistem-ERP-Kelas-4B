...
<html lang="en">
        ...
        <div id="layoutSidenav">
            ...
            <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Purchase Quotation</h1>
    ...
    <table id="export" class="table table-striped" style="width:100%">
        <thead>
            <tr>
                <th>No</th>
                <th>ID Purchase Inquiry</th>
                <th>ID Vendor</th>
                <th>Date Purchase Quotation</th>
                <th>List Of Material</th>
                <th>Total Price</th>
                <th>Tanggal Batas</th>
                <th>Status</th>
                <th>Aksi</th>
        ...
        <tbody>
            ...
            include "koneksi/koneksi.php";
            $no = 1;
            $tampil = mysqli_query($koneksi, "SELECT * FROM purchase_quotation ORDER BY id_purchase_quotation DESC");
            while ($data = mysqli_fetch_array($tampil)) {
                echo "<tr>
                <td>".$no."</td>
                <td>".$data['id_purchase_inquiry']."</td>
                <td>".$data['id_vendor']."</td>
                <td>".$data['date_purchase_quotation']."</td>
                <td>".$data['list_of_material']."</td>
                ...
                <div class='modal fade' id='modalubah".$no."' data-bs-backdrop='static' data-bs-keyboard='false' tabindex='-1' aria-labelledby='staticBackdropLabel' aria-hidden='true'>
                    <div class='modal-dialog'>
                        <div class='modal-content'>
                            ...
                            <form method='POST' action='aksi/aksi_purchasequotation.php'>
                                <input type='hidden' name='id_purchase_quotation' value='".$data['id_purchase_quotation']."'>
                                <div class='modal-body'>
                                    <div class='mb-3'>
                                        <label class='form-label'>ID Purchase Inquiry</label>
                                        <input type='number' class='form-control' name='id_purchase_inquiry' value='".$data['id_purchase_inquiry']."' placeholder='Masukkan Tanggal Mulai'>
                                    </div>
                                     <div class='mb-3'>
                                        <label class='form-label'>ID Vendor</label>
                                        <input type='number' class='form-control' name='id_vendor' value='".$data['id_vendor']."' placeholder='Masukkan Nama Produk'>
                                    </div>
                                    <div class='mb-3'>
                                        <label class='form-label'>Date Purchase Quotation</label>
                                        <input type='date' class='form-control' name='date_purchase_quotation' value='".$data['date_purchase_quotation']."' placeholder='Masukkan Tanggal Mulai'>
                                    </div>
                                    <div class='mb-3'>
                                        <label class='form-label'>List Of Material</label>
                                        <input type='text' class='form-control' name='list_of_material' value='".$data['list_of_material']."' placeholder='Masukkan Tanggal Mulai'>
                                    </div>
                                    <div class='mb-3'>
                                        <label class='form-label'>Total Price</label>
                                        <input type='text' class='form-control' name='total_price' value='".$data['total_price']."' placeholder='Masukkan Tanggal Mulai'>
                                    </div>
                                    <div class='mb-3'>
                                        <label class='form-label'>Valid Until</label>
                                        <input type='date' class='form-control' name='valid_until' value='".$data['valid_until']."' placeholder='Masukkan Tanggal Mulai'>
                                    </div>
                                    <div class='mb-3'>
                            ...
                            <form method='POST' action='aksi/aksi_purchasequotation.php'>
                                ...
                                <div class='modal-body'>
                                    <h5> Dengan menghapus data ini anda akan menghapus data dari daftar!<br><br>
                                        <span class='text-danger'>".$data['id_purchase_quotation']."</span>
                                    </h5>
                                </div>
                                <div class='modal-footer'>
                        ...
                        <div class="modal-content">
                            ...
                            <form method="POST" action="aksi/aksi_purchasequotation.php">
                                <div class="modal-body">
                                    <div class="mb-3">
                                        <label class="form-label">ID Purchase Inquiry</label>
                                        <input type="number" class="form-control" name="id_purchase_inquiry" placeholder="Masukkan ID Sales Order">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">ID Vendor</label>
                                        <input type="number" class="form-control" name="id_vendor" placeholder="Masukkan Tanggal Pengiriman">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Date Purchase Inquiry</label>
                                        <input type="date" class="form-control" name="date_purchase_quotation" placeholder="Masukkan ID Sales Order">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">List Of Material</label>
                                        <input type="text" class="form-control" name="list_of_material" placeholder="Masukkan ID Sales Order">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Total Price</label>
                                        <input type="text" class="form-control" name="total_price" placeholder="Masukkan ID Sales Order">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Valid Until</label>
                                        <input type="date" class="form-control" name="valid_until" placeholder="Masukkan ID Sales Order">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Status</label>
                                        <select class="form-select" name="status">
