...
<html lang="en">
            ...
            <main>
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            ...
                            <li class="breadcrumb-item active">gaji_karyawan</li>
                        </ol>
    ...
    <table id="export" class="table table-striped" style="width:100%">
        ...
        <tbody>
            ...
            include "koneksi/koneksi.php";
            $no = 1;
            $tampil = mysqli_query($koneksi, "SELECT * FROM gaji_karyawan ORDER BY id_gaji_karyawan DESC");
            while ($data = mysqli_fetch_array($tampil)) {
                echo "<tr>
                <td>".$no."</td>
                <td>".$data['nama_karyawan']."</td>
                <td>".$data['payroll_period']."</td>
                ...
                <div class='modal fade' id='modalubah".$no."' data-bs-backdrop='static' data-bs-keyboard='false' tabindex='-1' aria-labelledby='staticBackdropLabel' aria-hidden='true'>
                    <div class='modal-dialog'>
                        <div class='modal-content'>
                            ...
                            <form method='POST' action='aksi/aksi_gaji_karyawan.php'>
                                <input type='hidden' name='id_gaji_karyawan' value='".$data['id_gaji_karyawan']."'>
                                <div class='modal-body'>
                                    <div class='mb-3'>
                                        <label class='form-label'>Nama Karyawan</label>
                                        <input type='text' class='form-control' name='nama_karyawan' value='".$data['nama_karyawan']."' placeholder='Masukkan Nama Karyawan'>
                                    </div>
                                    <div class='mb-3'>
                                        <label class='form-label'>Gaji Karyawan</label>
                                        <input type='varchar' class='form-control' name='payroll_period' value='".$data['payroll_period']."' placeholder='Masukkan Gaji Karyawan'>
                                    </div>
                                </div>
                            ...
                            <form method='POST' action='aksi/aksi_gaji_karyawan.php'>
                                ...
                                <div class='modal-body'>
                                    <h5> Dengan menghapus data ini anda akan menghapus data dari daftar!<br><br>
                                        <span class='text-danger'>".$data['id_gaji_karyawan']."</span>
                                    </h5>
                                </div>
                                <div class='modal-footer'>
                        ...
                        <div class="modal-content">
                            ...
                            <form method="POST" action="aksi/aksi_gaji_karyawan.php">
                                <div class="modal-body">
                                    ...
                                    <div class="mb-3">
                                        <label class="form-label">Gaji Karyawan</label>
                                        <input type="varchar" class="form-control" name="payroll_period" placeholder="Masukkan Gaji Karyawan">
                                    </div>
                                    <div class="mb-3">
