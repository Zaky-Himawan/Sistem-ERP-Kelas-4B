        ...
        <div id="layoutSidenav">
            ...
            <main>
                <div class="container-fluid px-4">
                    <h1 class="mt-4">Inovasi Produk</h1>
                    <ol class="breadcrumb mb-4">
                        <li class="breadcrumb-item"><a href="index.html">Dashboard</a></li>
                        <li class="breadcrumb-item active">Inovasi Produk</li>
                    </ol>
                    <div class="container">
                        <table id="export" class="table table-striped" style="width:100%">
                            ...
                            <tbody>
                                <?php
                                $no = 1;
                                $tampil = mysqli_query($koneksi, "SELECT * FROM tinovasi ORDER BY id_inovasi DESC");
