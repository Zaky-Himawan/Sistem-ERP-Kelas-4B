...
<html lang="en">
        ...
        <div id="layoutSidenav">
            ...
            <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Melakukan Pembayaran</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="index.html">Dashboard</a></li>
                            <li class="breadcrumb-item active">Melakukan Payment</li>
                        </ol>
    ...
    <table id="export" class="table table-striped" style="width:100%">
        ...
        <tbody>
            ...
            include "koneksi/koneksi.php";
            $no = 1;
            $tampil = mysqli_query($koneksi, "SELECT * FROM pay ORDER BY id_pay DESC");
                ...
                <div class='modal fade' id='modalubah".$no."' data-bs-backdrop='static' data-bs-keyboard='false' tabindex='-1' aria-labelledby='staticBackdropLabel' aria-hidden='true'>
                    <div class='modal-dialog'>
                        <div class='modal-content'>
                            ...
                            <form method='POST' action='aksi/aksi_pay.php'>
                                <input type='hidden' name='id_pay' value='".$data['id_pay']."'>
                                <div class='modal-body'>
                                    <div class='mb-3'>
                                        <label class='form-label'>ID Purchase Order</label>
                                        <input type='int' class='form-control' name='id_purchase_order' value='".$data['id_purchase_order']."' placeholder='Masukkan ID'>
                                    </div>
                                    <div class='mb-3'>
                                        <label class='form-label'>ID User Order</label>
                                        <input type='int' class='form-control' name='id_user' value='".$data['id_user']."' placeholder='Masukkan ID'>
                                    </div>
                                    <div class='mb-3'>
                                        <label class='form-label'>Tanggal Pembayaran</label>
                                        <input type='date' class='form-control' name='date' value='".$data['date']."' placeholder='Masukkan Nama Tanggal'>
                                    </div>
                                    <div class='mb-3'>
                                        <label class='form-label'>Total Pembayaran</label>
                                        <input type='decimal' class='form-control' name='amount_paid' value='".$data['amount_paid']."' placeholder='Masukkan Jumlah'>
                                    <div class='mb-3'>
                            ...
                            <form method='POST' action='aksi/aksi_pay.php'>
                                ...
                                <div class='modal-body'>
                                    <h5> Dengan menghapus data ini anda akan menghapus data dari daftar!<br><br>
                                        <span class='text-danger'>".$data['id_pay']."</span>
                                    </h5>
                                </div>
                                <div class='modal-footer'>
                        ...
                        <div class="modal-content">
                            ...
                            <form method="POST" action="aksi/aksi_pay.php">
                                <div class="modal-body">
                                    <div class="mb-3">
                                        <label class="form-label">ID Purchase Order</label>
                                        <input type="int" class="form-control" name="id_purchase_order" placeholder="Masukkan ID">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">ID User</label>
                                        <input type="int" class="form-control" name="id_user" placeholder="Masukkan ID">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Tanggal Pembayaran</label>
                                    ...
                                    <div class="mb-3">
                                        <label class="form-label">Total Pembayaran</label>
                                        <input type="decimal" class="form-control" name="amount_paid" placeholder="Masukkan Jumlah">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Status</label>
                                        <select class="form-select" name="status">
                                            <option value="Berhasil">Completed</option>
