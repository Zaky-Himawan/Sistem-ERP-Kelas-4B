...
<html lang="en">
    ...
    <table id="export" class="table table-striped" style="width:100%">
        ...
        <tbody>
            ...
            include "koneksi/koneksi.php";
            $no = 1;
            $tampil = mysqli_query($koneksi, "SELECT * FROM data_vendor ORDER BY id_vendor DESC");
                ...
                <div class='modal fade' id='modalubah".$no."' data-bs-backdrop='static' data-bs-keyboard='false' tabindex='-1' aria-labelledby='staticBackdropLabel' aria-hidden='true'>
                    <div class='modal-dialog'>
                        <div class='modal-content'>
                            ...
                            <form method='POST' action='aksi/aksi_datavendor.php'>
                                <input type='hidden' name='id_vendor' value='".$data['id_vendor']."'>
                                <div class='modal-body'>
                                     <div class='mb-3'>
                                        <label class='form-label'>Nama Vendor</label>
                                        <input type='text' class='form-control' name='vendor_name' value='".$data['vendor_name']."' placeholder='Masukkan Nama Produk'>
                                    </div>
                                    <div class='mb-3'>
                                        <label class='form-label'>Phone</label>
                                        <input type='text' class='form-control' name='phone' value='".$data['phone']."' placeholder='Masukkan Tanggal Mulai'>
                                    </div>
                                     <div class='mb-3'>
                                        <label class='form-label'>Email</label>
                                        <input type='text' class='form-control' name='email' value='".$data['email']."' placeholder='Masukkan Tanggal Mulai'>
                                    </div>
                                     <div class='mb-3'>
                                        <label class='form-label'>Address</label>
                                        <input type='text' class='form-control' name='address' value='".$data['address']."' placeholder='Masukkan Tanggal Mulai'>
                                    </div>
                                     <div class='mb-3'>
                                        <label class='form-label'>Website</label>
                                        <input type='text' class='form-control' name='website' value='".$data['website']."' placeholder='Masukkan Tanggal Mulai'>
                                    </div>
                                </div>
                            ...
                            <form method='POST' action='aksi/aksi_datavendor.php'>
                                ...
                                <div class='modal-body'>
                                    <h5> Dengan menghapus data ini anda akan menghapus data dari daftar!<br><br>
                                        <span class='text-danger'>".$data['id_vendor']."</span>
                                    </h5>
                                </div>
                                <div class='modal-footer'>
                        ...
                        <div class="modal-content">
                            ...
                            <form method="POST" action="aksi/aksi_datavendor.php">
                                <div class="modal-body">
                                    <div class="mb-3">
                                        <label class="form-label">Nama Vendor</label>
                                        <input type="text" class="form-control" name="vendor_name" placeholder="Masukkan ID Sales Order">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Phone</label>
                                        <input type="text" class="form-control" name="phone" placeholder="Masukkan ID Sales Order">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Email</label>
                                        <input type="text" class="form-control" name="email" placeholder="Masukkan Tanggal Pengiriman">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Address</label>
                                        <input type="text" class="form-control" name="address" placeholder="Masukkan ID Sales Order">
                                    </div>                                    <div class="mb-3">
                                        <label class="form-label">Website</label>
                                        <input type="text" class="form-control" name="website" placeholder="Masukkan ID Sales Order">
                                    </div>
                                </div>
                                <div class="modal-footer">
