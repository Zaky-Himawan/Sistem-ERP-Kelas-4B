...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Stok Bahan Baku</h1>
                        ...
                        <div class="card mb-4">
                            ...
                            <a href="laporanstokbb.php" class="btn btn-info">Laporan Stok</a>
                            </div>
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?=$stok;?></td>
                                            <td>
                                                <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#update<?=$idbahan;?>">
                                                    Update
                                                </button>
                                                <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#delete<?=$idbahan;?>">
                                                    Delete
                                                </button>
                                            </td>
                                        </tr>
                                        ...
                                        <!--Update-->
                                        <div class="modal fade" id="update<?=$idbahan;?>">
                                            ...
                                            <button type="submit" class="btn btn-primary" name="updatebb">Submit</button>
                                            </div>
                                            </form>
                                            </div>
                                            </div>
                                        ...
                                        <div class="modal fade" id="delete<?=$idbahan;?>">
                                            ...
                                            <br>
                                            <br>
                                            <button type="submit" class="btn btn-danger" name="deletebb">Hapus</button>
                                            </div>
                                            </form>
                                            </div>
                                            </div>
        ...
        <script src="https://cdn.jsdelivr.net/npm/bootstrap@4.6.2/dist/js/bootstrap.bundle.min.js"></script>
            ...
            <div class="modal-header">
            <h4 class="modal-title">Input Bahan Baku</h4>
            <button type="button" class="close" data-dismiss="modal">&times;</button>
            </div>
            
            <form method="post">
            <div class="modal-body">
            <input type="text" name="nama_bahanbaku" placeholder="Nama Bahan Baku" class="form-control" autocomplete="off" required>
            <br>
            <input type="number" name="stok" placeholder="Jumlah" class="form-control" autocomplete="off" required>
            <br>
            <button type="submit" class="btn btn-primary" name="submitbb">Submit</button>
            </div>
            </form>
        </div>
        </div>
