...
<html lang="en">
        ...
        <div id="layoutSidenav">
            ...
            <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Sales Inquiry</h1>
    ...
    <table id="export" class="table table-striped" style="width:100%">
        ...
        <tbody>
            ...
            include "koneksi/koneksi.php";
            $no = 1;
            $tampil = mysqli_query($koneksi, "SELECT * FROM sales_inquiry ORDER BY id_sales_inquiry DESC");
            while ($data = mysqli_fetch_array($tampil)) {
                echo "<tr>
                <td>".$no."</td>
                <td>".$data['id_customer']."</td>
                <td>".$data['tanggal_inquiry']."</td>
                <td>".$data['status']."</td>
                <td>
                ...
                <div class='modal fade' id='modalubah".$no."' data-bs-backdrop='static' data-bs-keyboard='false' tabindex='-1' aria-labelledby='staticBackdropLabel' aria-hidden='true'>
                    <div class='modal-dialog'>
                        <div class='modal-content'>
                            ...
                            <form method='POST' action='aksi/aksi_salesinquiry.php'>
                                <input type='hidden' name='id_sales_inquiry' value='".$data['id_sales_inquiry']."'>
                                <div class='modal-body'>
                                    <div class='mb-3'>
                                        <label class='form-label'>date inquiry</label>
                                        <input type='date' class='form-control' name='tanggal_inquiry' value='".$data['tanggal_inquiry']."' placeholder='Masukkan Date Inquiry'>
                                    </div>
                                    <div class='mb-3'>
                            ...
                            <form method='POST' action='aksi/aksi_salesinquiry.php'>
                                ...
                                <div class='modal-body'>
                                    <h5> Dengan menghapus data ini anda akan menghapus data dari daftar!<br><br>
                                        <span class='text-danger'>".$data['id_sales_inquiry']."</span>
                                    </h5>
                                </div>
                                <div class='modal-footer'>
                        ...
                        <div class="modal-content">
                            ...
                            <form method="POST" action="aksi/aksi_salesinquiry.php">
                                ...
                                <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="id_customer" placeholder=" ">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">date inquiry</label>
                                        <input type="date" class="form-control" name="tanggal_inquiry" placeholder=" ">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Status</label>
                                        <select class="form-select" name="status">
