...
<html lang="en">
        ...
        <div id="layoutSidenav">
            ...
            <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Pemasaran Produk</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="index.html">Dashboard</a></li>
                            <li class="breadcrumb-item active">Pemasaran Produk</li>
                        </ol>
    ...
    <table id="export" class="table table-striped" style="width:100%">
        ...
        <tbody>
            ...
            include "koneksi/koneksi.php";
            $no = 1;
            $tampil = mysqli_query($koneksi, "SELECT * FROM pemasaran_produk ORDER BY id_pemasaran DESC");
            while ($data = mysqli_fetch_array($tampil)) {
                echo "<tr>
                <td>".$no."</td>
                <td>".$data['id_customer']."</td>
                <td>".$data['nama_pemasanan']."</td>
                ...
                <div class='modal fade' id='modalubah".$no."' data-bs-backdrop='static' data-bs-keyboard='false' tabindex='-1' aria-labelledby='staticBackdropLabel' aria-hidden='true'>
                    <div class='modal-dialog'>
                        <div class='modal-content'>
                            ...
                            <form method='POST' action='aksi/aksi_pemasaranproduk.php'>
                                <input type='hidden' name='id_pemasaran' value='".$data['id_pemasaran']."'>
                                <div class='modal-body'>
                                    <div class='mb-3'>
                                        <label class='form-label'>ID Customer</label>
                                        <input type='text' class='form-control' name='id_customer' value='".$data['id_customer']."' placeholder='Masukkan ID Customer'>
                                    </div>
                                    <div class='mb-3'>
                                        <label class='form-label'>Nama Pemasanan</label>
                                        <input type='text' class='form-control' name='nama_pemasanan' value='".$data['nama_pemasanan']."' placeholder='Masukkan Nama Pemasanan'>
                                    </div>
                                    <div class='mb-3'>
                                        <label class='form-label'>Tanggal Mulai</label>
                                        <input type='date' class='form-control' name='tanggal_mulai' value='".$data['tanggal_mulai']."' placeholder='Masukkan Tanggal Mulai'>
                                    </div>
                                    <div class='mb-3'>
                                        <label class='form-label'>Tanggal Selesai</label>
                                        <input type='date' class='form-control' name='tanggal_selesai' value='".$data['tanggal_selesai']."' placeholder='Masukkan Tanggal Selesai'>
                                    </div>
                                    <div class='mb-3'>
                            ...
                            <form method='POST' action='aksi/aksi_pemasaranproduk.php'>
                                ...
                                <div class='modal-body'>
                                    <h5> Dengan menghapus data ini anda akan menghapus data dari daftar!<br><br>
                                        <span class='text-danger'>".$data['id_pemasaran']."</span>
                                    </h5>
                                </div>
                                <div class='modal-footer'>
                        ...
                        <div class="modal-content">
                            ...
                            <form method="POST" action="aksi/aksi_pemasaranproduk.php">
                                <div class="modal-body">
                                    <div class="mb-3">
                                        <label class="form-label">ID Customer</label>
                                        <input type="number" class="form-control" name="id_customer" placeholder="Masukkan ID customer">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Nama Pemasanan</label>
                                        <input type="text" class="form-control" name="nama_pemasanan" placeholder="Masukkan Pemasanan">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Tanggal Mulai</label>
                                        <input type="date" class="form-control" name="tanggal_mulai" placeholder="Masukkan Date Invoice">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Tanggal Selesai</label>
                                        <input type="date" class="form-control" name="tanggal_selesai" placeholder="Masukkan Date Invoice">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Status</label>
                                        <select class="form-select" name="status">
