...
<html lang="en">
        ...
        <div id="layoutSidenav">
            ...
            <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">input_purchase</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="index.html">Dashboard</a></li>
                            <li class="breadcrumb-item active">input_purchase</li>
                        </ol>
    ...
    <table id="export" class="table table-striped" style="width:100%">
        ...
        <tbody>
            ...
            include "koneksi/koneksi.php";
            $no = 1;
            $tampil = mysqli_query($koneksi, "SELECT * FROM input_purchase ORDER BY id_input_purchase DESC");
                ...
                <div class='modal fade' id='modalubah".$no."' data-bs-backdrop='static' data-bs-keyboard='false' tabindex='-1' aria-labelledby='staticBackdropLabel' aria-hidden='true'>
                    <div class='modal-dialog'>
                        <div class='modal-content'>
                            ...
                            <form method='POST' action='aksi/aksi_input_purchase.php'>
                                <input type='hidden' name='id_input_purchase' value='".$data['id_input_purchase']."'>
                                <div class='modal-body'>
                                    ...
                                    <div class='mb-3'>
                                        ...
                                        <input type='decimal' class='form-control' name='amount' value='".$data['amount']."' placeholder='Masukkan Amount'>
                                    </div>
                                </div>
                            ...
                            <form method='POST' action='aksi/aksi_input_purchase.php'>
                                ...
                                <div class='modal-body'>
                                    <h5> Dengan menghapus data ini anda akan menghapus data dari daftar!<br><br>
                                        <span class='text-danger'>".$data['id_input_purchase']."</span>
                                    </h5>
                                </div>
                                <div class='modal-footer'>
                        ...
                        <div class="modal-content">
                            ...
                            <form method="POST" action="aksi/aksi_input_purchase.php">
                                <div class="modal-body">
                                    ...
                                    <div class="mb-3">
                                        <label class="form-label">Amount</label>
                                        <input type="decimal" class="form-control" name="amount" placeholder="Masukkan Amount">
                                    </div>
                                </div>
                                <div class="modal-footer">
