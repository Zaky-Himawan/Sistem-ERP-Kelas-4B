...
<html lang="en">
        ...
        <div id="layoutSidenav">
            ...
            <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Pengembangan Produk</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="index.html">Dashboard</a></li>
                            <li class="breadcrumb-item active">Pengembangan Produk</li>
                        </ol>
    ...
    <table id="export" class="table table-striped" style="width:100%">
        ...
        <tbody>
            ...
            include "koneksi/koneksi.php";
            $no = 1;
            $tampil = mysqli_query($koneksi, "SELECT * FROM tpengembangan ORDER BY id_pengembangan DESC");
                ...
                <div class='modal fade' id='modalubah".$no."' data-bs-backdrop='static' data-bs-keyboard='false' tabindex='-1' aria-labelledby='staticBackdropLabel' aria-hidden='true'>
                    <div class='modal-dialog'>
                        <div class='modal-content'>
                            ...
                            <form method='POST' action='aksi/aksi_pengembangan.php'>
                                <input type='hidden' name='id_pengembangan' value='".$data['id_pengembangan']."'>
                                <div class='modal-body'>
                                    ...
                                    <div class='mb-3'>
                                        ...
                                        <select class='form-select' name='tstatus'>
                                            ...
                                            <option value='Belum Layak' ".(($data['status'] == 'Belum Layak') ? 'selected' : '').">Belum Layak</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select" name="tstatus">
                                            ...
                                            <option value="Belum Dimulai">Belum Layak</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="modal-footer">
