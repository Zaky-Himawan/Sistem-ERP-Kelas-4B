...
<html lang="en">
        ...
        <div id="layoutSidenav">
            ...
            <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Material Entry</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="index.html">Dashboard</a></li>
                            <li class="breadcrumb-item active">Material Entry</li>
                        </ol>
    ...
    <table id="export" class="table table-striped" style="width:100%">
        ...
        <tbody>
            ...
            include "koneksi/koneksi.php";
            $no = 1;
            $tampil = mysqli_query($koneksi, "SELECT * FROM material ORDER BY id_material DESC");
                ...
                <div class='modal fade' id='modalubah".$no."' data-bs-backdrop='static' data-bs-keyboard='false' tabindex='-1' aria-labelledby='staticBackdropLabel' aria-hidden='true'>
                    <div class='modal-dialog'>
                        <div class='modal-content'>
                            ...
                            <form method='POST' action='aksi/aksi_material.php'>
                                <input type='hidden' name='id_material' value='".$data['id_material']."'>
                                <div class='modal-body'>
                                     <div class='mb-3'>
                                        <label class='form-label'>Material Name</label>
                                        <input type='text' class='form-control' name='material_name' value='".$data['material_name']."' placeholder='Masukkan Nama Produk'>
                                    </div>
                                    <div class='mb-3'>
                                        <label class='form-label'>Unit Price</label>
                                        <input type='number' class='form-control' name='unit_price' value='".$data['unit_price']."' placeholder='Masukkan Tanggal Mulai'>
                                    </div>
                                    <div class='mb-3'>
                            ...
                            <form method='POST' action='aksi/aksi_material.php'>
                                ...
                                <div class='modal-body'>
                                    <h5> Dengan menghapus data ini anda akan menghapus data dari daftar!<br><br>
                                        <span class='text-danger'>".$data['id_material']."</span>
                                    </h5>
                                </div>
                                <div class='modal-footer'>
                            ...
                            <form method="POST" action="aksi/aksi_material.php">
                                <div class="modal-body">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="material_name" placeholder="Masukkan ID Sales Order">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Unit Price</label>
                                        <input type="number" class="form-control" name="unit_price" placeholder="Masukkan Tanggal Pengiriman">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Status</label>
                                        <select class="form-select" name="status">
