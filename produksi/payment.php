...
<html lang="en">
    ...
    <table id="export" class="table table-striped" style="width:100%">
        ...
        <tbody>
            ...
            include "koneksi/koneksi.php";
            $no = 1;
            $tampil = mysqli_query($koneksi, "SELECT * FROM payment ORDER BY id_payment DESC");
                ...
                <div class='modal fade' id='modalubah".$no."' data-bs-backdrop='static' data-bs-keyboard='false' tabindex='-1' aria-labelledby='staticBackdropLabel' aria-hidden='true'>
                    <div class='modal-dialog'>
                        <div class='modal-content'>
                            ...
                            <form method='POST' action='aksi/aksi_payment.php'>
                                <input type='hidden' name='id_payment' value='".$data['id_payment']."'>
                                <div class='modal-body'>
                                    <div class='mb-3'>
                                        <label class='form-label'>Amount</label>
                                        <input type='number' class='form-control' name='amount' value='".$data['amount']."' placeholder='Masukkan Tanggal'>
                                    </div>
                                    <div class='mb-3'>
                                        <label class='form-label'>Payment Date</label>
                                        <input type='date' class='form-control' name='payment_date' value='".$data['payment_date']."' placeholder='Masukkan Nama Produk'>
                                    </div>
                                    <div class='mb-3'>
                                        <label class='form-label'>Payment Method</label>
                                        <input type='number' class='form-control' name='payment_method' value='".$data['payment_method']."' placeholder='Masukkan Jumlah'>
                                    </div>
                                    <div class='mb-3'>
                                        <label class='form-label'>Total</label>
                                        <input type='number' class='form-control' name='total' value='".$data['total']."' placeholder='Masukkan Jumlah'>
                                    <div class='mb-3'>
                                        <label class='form-label'>Status</label>
                                        <select class='form-select' name='status'>
                                            <option value='Berhasil' ".(($data['status'] == 'Berhasil') ? 'selected' : '').">Completed</option>
                                            <option value='Belum Menerima' ".(($data['status'] == 'Belum Menerima') ? 'selected' : '').">Cancelled</option>
                                        </select>
                                </div>
                            ...
                            <form method='POST' action='aksi/aksi_payment.php'>
                                ...
                                <div class='modal-body'>
                                    <h5> Dengan menghapus data ini anda akan menghapus data dari daftar!<br><br>
                                        <span class='text-danger'>".$data['id_payment']."</span>
                                    </h5>
                                </div>
                                <div class='modal-footer'>
                        ...
                        <div class="modal-content">
                            ...
                            <form method="POST" action="aksi/aksi_payment.php">
                                <div class="modal-body">
                                    ...
                                    <div class="mb-3">
                                        <label class="form-label">Payment Date</label>
                                        <input type="date" class="form-control" name="payment_date" placeholder="Masukkan Payment Date">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Payment Method</label>
                                        <input type="text" class="form-control" name="payment_method" placeholder="Masukkan Payment Method">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Total</label>
