...
<html lang="en">
        ...
        <div id="layoutSidenav">
            ...
            <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">income_statement</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="index.html">Dashboard</a></li>
                            <li class="breadcrumb-item active">income_statement</li>
                        </ol>
    ...
    <table id="export" class="table table-striped" style="width:100%">
        ...
        <tbody>
            ...
            include "koneksi/koneksi.php";
            $no = 1;
            $tampil = mysqli_query($koneksi, "SELECT * FROM income_statement ORDER BY id_income_statement DESC");
                ...
                <div class='modal fade' id='modalubah".$no."' data-bs-backdrop='static' data-bs-keyboard='false' tabindex='-1' aria-labelledby='staticBackdropLabel' aria-hidden='true'>
                    <div class='modal-dialog'>
                        <div class='modal-content'>
                            ...
                            <form method='POST' action='aksi/aksi_income_statement.php'>
                                <input type='hidden' name='id_income_statement' value='".$data['id_income_statement']."'>
                                <div class='modal-body'>
                                    <div class='mb-3'>
                                        <label class='form-label'>Tanggal Mulai Periode</label>
                                        <input type='date' class='form-control' name='start_date' value='".$data['start_date']."' placeholder='Masukkan Tanggal Mulai Periode'>
                                    </div>
                                    <div class='mb-3'>
                                        <label class='form-label'>Tanggal Akhir Periode</label>
                                        <input type='date' class='form-control' name='end_date' value='".$data['end_date']."' placeholder='Masukkan Tanggal Akhir Periode'>
                                    </div>
                                    <div class='mb-3'>
                                        <label class='form-label'>Total Pendapatan</label>
                                        <input type='decimal' class='form-control' name='total_income' value='".$data['total_income']."' placeholder='Masukkan Total Pendapatan'>
                                    </div>
                                    <div class='mb-3'>
                                        <label class='form-label'>Total Pengeluaran</label>
                                        <input type='decimal' class='form-control' name='total_expense' value='".$data['total_expense']."' placeholder='Masukkan Total Pengeluaran'>
                                    </div>
                                    <div class='mb-3'>
                            ...
                            <form method='POST' action='aksi/aksi_income_statement.php'>
                                ...
                                <div class='modal-body'>
                                    <h5> Dengan menghapus data ini anda akan menghapus data dari daftar!<br><br>
                                        <span class='text-danger'>".$data['id_income_statement']."</span>
                                    </h5>
                                </div>
                                <div class='modal-footer'>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <form method="POST" action="aksi/aksi_income_statement.php">
                                <div class="modal-body">
                                    <div class="mb-3">
                                        <label class="form-label">Tanggal Awal Periode</label>
                                        <input type="date" class="form-control" name="start_date" placeholder="Masukkan Tanggal Awal Periode">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Tanggal Akhir Periode</label>
                                        <input type="date" class="form-control" name="end_date" placeholder="Masukkan Tanggal Akhir Periode">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Total Pendapatan</label>
                                        <input type="decimal" class="form-control" name="total_income" placeholder="Masukkan Total Pendapatan">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Total Pengeluaran</label>
                                        <input type="decimal" class="form-control" name="total_expense" placeholder="Masukkan Total Pengeluaran">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Pendapatan Bersih</label>
