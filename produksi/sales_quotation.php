...
<html lang="en">
        ...
        <div id="layoutSidenav">
            ...
            <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Sales Quotation</h1>
    ...
    <table id="export" class="table table-striped" style="width:100%">
        ...
        <tbody>
            ...
            include "koneksi/koneksi.php";
            $no = 1;
            $tampil = mysqli_query($koneksi, "SELECT * FROM sales_quotation ORDER BY id_sales_quotation DESC");
            while ($data = mysqli_fetch_array($tampil)) {
                echo "<tr>
                <td>".$no."</td>
                <td>".$data['id_sales_inquiry']."</td>
                ...
                <div class='modal fade' id='modalubah".$no."' data-bs-backdrop='static' data-bs-keyboard='false' tabindex='-1' aria-labelledby='staticBackdropLabel' aria-hidden='true'>
                    <div class='modal-dialog'>
                        <div class='modal-content'>
                            ...
                            <form method='POST' action='aksi/aksi_salesquotation.php'>
                                <input type='hidden' name='id_sales_quotation' value='".$data['id_sales_quotation']."'>
                                <div class='modal-body'>
                                    <div class='mb-3'>
                                        <label class='form-label'>ID Sales Inquiry</label>
                                        <input type='text' class='form-control' name='id_sales_inquiry' value='".$data['id_sales_inquiry']."' placeholder='Masukkan ID Sales Inquiry'>
                                    </div>
                                    <div class='mb-3'>
                                    ...
                                    <div class='mb-3'>
                                        ...
                                        <input type='text' class='form-control' name='total' value='".$data['total']."' placeholder='Masukkan Total'>
                                    </div>
                                    <div class='mb-3'>
                            ...
                            <form method='POST' action='aksi/aksi_salesquotation.php'>
                                ...
                                <div class='modal-body'>
                                    <h5> Dengan menghapus data ini anda akan menghapus data dari daftar!<br><br>
                                        <span class='text-danger'>".$data['id_sales_quotation']."</span>
                                    </h5>
                                </div>
                                <div class='modal-footer'>
                        ...
                        <div class="modal-content">
                            ...
                            <form method="POST" action="aksi/aksi_salesquotation.php">
                                <div class="modal-body">
                                    <div class="mb-3">
                                        <label class="form-label">ID Sales Inquiry</label>
                                        <input type="text" class="form-control" name="id_sales_inquiry" placeholder="Masukkan ID Sales Inquiry">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">ID Customer</label>
                                        <input type="text" class="form-control" name="id_customer" placeholder="Masukkan ID customer">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">ID Produk</label>
                                    ...
                                    <div class="mb-3">
                                        <label class="form-label">Total</label>
                                        <input type="text" class="form-control" name="total" placeholder="Masukkan total">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Status</label>
                                        <select class="form-select" name="status">
