...
<html lang="en">
        ...
        <div id="layoutSidenav">
            ...
            <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Permintaan Bahan Baku</h1>
    ...
    <table id="export" class="table table-striped" style="width:100%">
        ...
        <tbody>
            ...
            include "koneksi/koneksi.php";
            $no = 1;
            $tampil = mysqli_query($koneksi, "SELECT * FROM tbahanbaku ORDER BY id_bahanbaku DESC");
                ...
                <div class='modal fade' id='modalubah".$no."' data-bs-backdrop='static' data-bs-keyboard='false' tabindex='-1' aria-labelledby='staticBackdropLabel' aria-hidden='true'>
                    <div class='modal-dialog'>
                        <div class='modal-content'>
                            ...
                            <form method='POST' action='aksi/aksi_bahanbaku.php'>
                                <input type='hidden' name='id_bahanbaku' value='".$data['id_bahanbaku']."'>
                                <div class='modal-body'>
                                    ...
                                    <div class='mb-3'>
                                        ...
                                        <input type='text' class='form-control' name='tnama_bahanbaku' value='".$data['nama_bahanbaku']."' placeholder='Masukkan Nama Bahan Baku'>
                                    </div>
                                    <div class='mb-3'>
                                    ...
                                    <div class='mb-3'>
                                        ...
                                        <select class='form-select' name='tstatus'>
                                            <option value='Diminta' ".(($data['status'] == 'Diminta') ? 'selected' : '').">Diminta</option>
                                            <option value='Sudah Diterima' ".(($data['status'] == 'Sudah Diterima') ? 'selected' : '').">Sudah Diterima</option>
                                        </select>
                                    </div>
                                </div>
                            ...
                            <form method='POST' action='aksi/aksi_bahanbaku.php'>
                                ...
                                <div class='modal-body'>
                                    <h5> Dengan menghapus data ini anda akan menghapus data dari daftar!<br><br>
                                        <span class='text-danger'>".$data['nama_bahanbaku']."</span>
                                    </h5>
                                </div>
                                <div class='modal-footer'>
                        ...
                        <div class="modal-content">
                            ...
                            <form method="POST" action="aksi/aksi_bahanbaku.php">
                                <div class="modal-body">
                                    ...
                                    <div class="mb-3">
                                        <label class="form-label">Nama Bahan Baku</label>
                                        <input type="text" class="form-control" name="tnama_bahanbaku" placeholder="Masukkan Nama Bahan Baku">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Jumlah</label>
