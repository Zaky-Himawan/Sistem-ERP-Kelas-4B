...
<html lang="en">
    ...
    <table id="export" class="table table-striped" style="width:100%">
        ...
        <tbody>
            ...
            include "koneksi/koneksi.php";
            $no = 1;
            $tampil = mysqli_query($koneksi, "SELECT * FROM sales_order ORDER BY id_sales_order DESC");
            while ($data = mysqli_fetch_array($tampil)) {
                echo "<tr>
                <td>".$no."</td>
                <td>".$data['id_sales_quotation']."</td>
                ...
                <div class='modal fade' id='modalubah".$no."' data-bs-backdrop='static' data-bs-keyboard='false' tabindex='-1' aria-labelledby='staticBackdropLabel' aria-hidden='true'>
                    <div class='modal-dialog'>
                        <div class='modal-content'>
                            ...
                            <form method='POST' action='aksi/aksi_salesorder.php'>
                                <input type='hidden' name='id_sales_order' value='".$data['id_sales_order']."'>
                                <div class='modal-body'>
                                    <div class='mb-3'>
                                     <div class='mb-3'>
                                        <label class='form-label'>ID Sales Quotation</label>
                                        <input type='text' class='form-control' name='id_sales_quotation' value='".$data['id_sales_quotation']."' placeholder='Masukkan ID Sales Quotation'>
                                    </div>
                                     <div class='mb-3'>
                                        <label class='form-label'>ID Produk</label>
                                        <input type='text' class='form-control' name='id_produk' value='".$data['id_produk']."' placeholder='Masukkan ID Produk'>
                                    </div>
                                        <label class='form-label'>Tangga Order</label>
                                        <input type='date' class='form-control' name='tanggal_order' value='".$data['tanggal_order']."' placeholder='Masukkan Tanggal order'>
                                    </div>
                                    <div class='mb-3'>
                                        <label class='form-label'>Detail order</label>
                                        <input type='text' class='form-control' name='detail_order' value='".$data['detail_order']."' placeholder='Masukkan Detail Orderr'>
                                    </div>
                                    <div class='mb-3'>
                            ...
                            <form method='POST' action='aksi/aksi_salesorder.php'>
                                ...
                                <div class='modal-body'>
                                    <h5> Dengan menghapus data ini anda akan menghapus data dari daftar!<br><br>
                                        <span class='text-danger'>".$data['id_sales_order']."</span>
                                    </h5>
                                </div>
                                <div class='modal-footer'>
                        ...
                        <div class="modal-content">
                            ...
                            <form method="POST" action="aksi/aksi_salesorder.php">
                                <div class="modal-body">
                                    <div class="mb-3">
                                        <label class="form-label">ID Sales Quotation</label>
                                        <input type="text" class="form-control" name="id_sales_quotation" placeholder="Masukkan ID Sales Quotation">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">ID produk</label>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="date" class="form-control" name="tanggal_order" placeholder="Masukkan Tanggal Order">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Detail Order</label>
                                        <input type="text" class="form-control" name="detail_order" placeholder="Masukkan Detail Order">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Status</label>
                                        <select class="form-select" name="status">
