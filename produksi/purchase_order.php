...
<html lang="en">
    ...
    <table id="export" class="table table-striped" style="width:100%">
        ...
        <tbody>
            ...
            include "koneksi/koneksi.php";
            $no = 1;
            $tampil = mysqli_query($koneksi, "SELECT * FROM purchase_order ORDER BY id_purchase_order DESC");
            while ($data = mysqli_fetch_array($tampil)) {
                echo "<tr>
                <td>".$no."</td>
                <td>".$data['id_purchase_quotation']."</td>
                <td>".$data['id_material']."</td>
                <td>".$data['date_purchase_order']."</td>
                ...
                <div class='modal fade' id='modalubah".$no."' data-bs-backdrop='static' data-bs-keyboard='false' tabindex='-1' aria-labelledby='staticBackdropLabel' aria-hidden='true'>
                    <div class='modal-dialog'>
                        <div class='modal-content'>
                            ...
                            <form method='POST' action='aksi/aksi_purchaseorder.php'>
                                <input type='hidden' name='id_purchase_order' value='".$data['id_purchase_order']."'>
                                <div class='modal-body'>
                                    <div class='mb-3'>
                                        <label class='form-label'>ID Purchase Quotation</label>
                                        <input type='number' class='form-control' name='id_purchase_quotation' value='".$data['id_purchase_quotation']."' placeholder='Masukkan Tanggal Mulai'>
                                    </div>
                                     <div class='mb-3'>
                                    ...
                                    <div class='mb-3'>
                                        <label class='form-label'>Date Purchase Order</label>
                                        <input type='date' class='form-control' name='date_purchase_order' value='".$data['date_purchase_order']."' placeholder='Masukkan Tanggal Mulai'>
                                    </div>
                                    <div class='mb-3'>
                                        <label class='form-label'>Unit Price</label>
                                        <input type='text' class='form-control' name='unit_price' value='".$data['unit_price']."' placeholder='Masukkan Tanggal Mulai'>
                                    </div>
                                    <div class='mb-3'>
                                        <label class='form-label'>Total Order</label>
                                        <input type='text' class='form-control' name='total_order' value='".$data['total_order']."' placeholder='Masukkan Tanggal Mulai'>
                                    </div>
                                    <div class='mb-3'>
                                        <label class='form-label'>Shipping Method</label>
                                        <select class='form-select' name='shipping_method'>
                                            <option value='E-Money' ".(($data['shipping_method'] == 'E-Money') ? 'selected' : '').">E-Money</option>
                                            <option value='Bank' ".(($data['shipping_method'] == 'Bank') ? 'selected' : '').">Bank</option>
                                        </select>
                                    </div>
                                    <div class='mb-3'>
                                    ...
                                    <div class='mb-3'>
                                        ...
                                        <input type='date' class='form-control' name='expected_delivery_date' value='".$data['expected_delivery_date']."' placeholder='Masukkan Tanggal Mulai'>
                                    </div>
                                    <div class='mb-3'>
                            ...
                            <form method='POST' action='aksi/aksi_purchaseorder.php'>
                                ...
                                <div class='modal-body'>
                                    <h5> Dengan menghapus data ini anda akan menghapus data dari daftar!<br><br>
                                        <span class='text-danger'>".$data['id_purchase_order']."</span>
                                    </h5>
                                </div>
                                <div class='modal-footer'>
                        ...
                        <div class="modal-content">
                            ...
                            <form method="POST" action="aksi/aksi_purchaseorder.php">
                                <div class="modal-body">
                                    <div class="mb-3">
                                        <label class="form-label">ID Purchase Quotation</label>
                                        <input type="number" class="form-control" name="id_purchase_quotation" placeholder="Masukkan ID Sales Order">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">ID Material</label>
                                    ...
                                    <div class="mb-3">
                                        <label class="form-label">Date Purchase Order</label>
                                        <input type="date" class="form-control" name="date_purchase_order" placeholder="Masukkan ID Sales Order">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Unit Price</label>
                                        <input type="text" class="form-control" name="unit_price" placeholder="Masukkan ID Sales Order">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Total Order</label>
                                        <input type="number" class="form-control" name="total_order" placeholder="Masukkan ID Sales Order">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Shipping Method</label>
                                        <select class="form-select" name="shipping_method">
                                    ...
                                    <div class="mb-3">
                                        <label class="form-label">Expected Delivery Date</label>
                                        <input type="date" class="form-control" name="expected_delivery_date" placeholder="Masukkan ID Sales Order">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Status</label>
                                        <select class="form-select" name="status">
