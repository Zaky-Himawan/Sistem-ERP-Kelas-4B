...
<html lang="en">
        ...
        <div id="layoutSidenav">
            ...
            <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Purchase Requisition</h1>
    ...
    <table id="export" class="table table-striped" style="width:100%">
        <thead>
            <tr>
                <th>No</th>
                <th>ID User Request</th>
                <th>Date Purchase Requisition</th>
                <th>Departement</th>
                <th>Status</th>
                <th>Aksi</th>
            </tr>
        ...
        <tbody>
            ...
            include "koneksi/koneksi.php";
            $no = 1;
            $tampil = mysqli_query($koneksi, "SELECT * FROM purchase_requisition ORDER BY id_purchase_requisition DESC");
            while ($data = mysqli_fetch_array($tampil)) {
                echo "<tr>
                <td>".$no."</td>
                <td>".$data['id_user_request']."</td>
                <td>".$data['date_purchase_requisition']."</td>
                ...
                <div class='modal fade' id='modalubah".$no."' data-bs-backdrop='static' data-bs-keyboard='false' tabindex='-1' aria-labelledby='staticBackdropLabel' aria-hidden='true'>
                    <div class='modal-dialog'>
                        <div class='modal-content'>
                            ...
                            <form method='POST' action='aksi/aksi_purchaserequisition.php'>
                                <input type='hidden' name='id_purchase_requisition' value='".$data['id_purchase_requisition']."'>
                                <div class='modal-body'>
                                    <div class='mb-3'>
                                        <label class='form-label'>ID User Request</label>
                                        <input type='text' class='form-control' name='id_user_request' value='".$data['id_user_request']."' placeholder='Masukkan Tanggal Mulai'>
                                    </div>
                                     <div class='mb-3'>
                                        <label class='form-label'>Date Purchase Requisition</label>
                                        <input type='date' class='form-control' name='date_purchase_requisition' value='".$data['date_purchase_requisition']."' placeholder='Masukkan Nama Produk'>
                                    </div>
                                    <div class='mb-3'>
                                        <label class='form-label'>Departement</label>
                                        <input type='text' class='form-control' name='departement' value='".$data['departement']."' placeholder='Masukkan Tanggal Mulai'>
                                    </div>
                                    <div class='mb-3'>
                            ...
                            <form method='POST' action='aksi/aksi_purchaserequisition.php'>
                                ...
                                <div class='modal-body'>
                                    <h5> Dengan menghapus data ini anda akan menghapus data dari daftar!<br><br>
                                        <span class='text-danger'>".$data['id_purchase_requisition']."</span>
                                    </h5>
                                </div>
                                <div class='modal-footer'>
                        ...
                        <div class="modal-content">
                            ...
                            <form method="POST" action="aksi/aksi_purchaserequisition.php">
                                <div class="modal-body">
                                    <div class="mb-3">
                                        <label class="form-label">ID User Request</label>
                                        <input type="text" class="form-control" name="id_user_request" placeholder="Masukkan ID Sales Order">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Date Purchase Requisition</label>
                                        <input type="date" class="form-control" name="date_purchase_requisition" placeholder="Masukkan Tanggal Pengiriman">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Departement</label>
                                        <input type="text" class="form-control" name="departement" placeholder="Masukkan ID Sales Order">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Status</label>
                                        <select class="form-select" name="status">
