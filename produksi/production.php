...
<html lang="en">
    ...
    <table id="export" class="table table-striped" style="width:100%">
        ...
        <tbody>
            ...
            include "koneksi/koneksi.php";
            $no = 1;
            $tampil = mysqli_query($koneksi, "SELECT * FROM production ORDER BY id_production DESC");
                ...
                <div class='modal fade' id='modalubah".$no."' data-bs-backdrop='static' data-bs-keyboard='false' tabindex='-1' aria-labelledby='staticBackdropLabel' aria-hidden='true'>
                    <div class='modal-dialog'>
                        <div class='modal-content'>
                            ...
                            <form method='POST' action='aksi/aksi_production.php'>
                                <input type='hidden' name='id_production' value='".$data['id_production']."'>
                                <div class='modal-body'>
                                    <div class='mb-3'>
                                        <label class='form-label'>Name</label>
                                        <input type='varchar' class='form-control' name='name' value='".$data['name']."' placeholder='Masukkan Nama Produksi'>
                                    </div>
                                    <div class='mb-3'>
                                        <label class='form-label'>Description</label>
                                        <input type='text' class='form-control' name='description' value='".$data['description']."' placeholder='Masukkan Deskrpsi Produksi'>
                                    </div>
                                    <div class='mb-3'>
                                        <label class='form-label'>Price</label>
                                        <input type='decimal' class='form-control' name='price' value='".$data['price']."' placeholder='Masukkan Price'>
                                    </div>
                                </div>
                            ...
                            <form method='POST' action='aksi/aksi_production.php'>
                                ...
                                <div class='modal-body'>
                                    <h5> Dengan menghapus data ini anda akan menghapus data dari daftar!<br><br>
                                        <span class='text-danger'>".$data['id_production']."</span>
                                    </h5>
                                </div>
                                <div class='modal-footer'>
                        ...
                        <div class="modal-content">
                            ...
                            <form method="POST" action="aksi/aksi_production.php">
                                <div class="modal-body">
                                    <div class="mb-3">
                                        <label class="form-label">Name</label>
                                        <input type="varchar" class="form-control" name="name" placeholder="Masukkan Nama Produksi">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Description</label>
                                        <input type="text" class="form-control" name="description" placeholder="Masukkan Deskripsi Produksi">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Price</label>
                                        <input type="decimal" class="form-control" name="price" placeholder="Masukkan Price">
                                    </div>
                                    <div class="mb-3">
