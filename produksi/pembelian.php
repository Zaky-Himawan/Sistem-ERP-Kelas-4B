...
<html lang="en">
    ...
    <table id="export" class="table table-striped" style="width:100%">
        ...
        <tbody>
            ...
            include "koneksi/koneksi.php";
            $no = 1;
            $tampil = mysqli_query($koneksi, "SELECT * FROM pembelian ORDER BY id_pembelian DESC");
                ...
                <div class='modal fade' id='modalubah".$no."' data-bs-backdrop='static' data-bs-keyboard='false' tabindex='-1' aria-labelledby='staticBackdropLabel' aria-hidden='true'>
                    <div class='modal-dialog'>
                        <div class='modal-content'>
                            ...
                            <form method='POST' action='aksi/aksi_pembelian.php'>
                                <input type='hidden' name='id_pembelian' value='".$data['id_pembelian']."'>
                                <div class='modal-body'>
                                    <div class='mb-3'>
                                        <label class='form-label'>ID Vendor</label>
                                        <input type='int' class='form-control' name='id_vendor' value='".$data['id_vendor']."' placeholder='Masukkan ID Vendor'>
                                    </div>
                                    <div class='mb-3'>
                                        <label class='form-label'>ID Order</label>
                                        <input type='varchar' class='form-control' name='id_order' value='".$data['id_order']."' placeholder='Masukkan ID Order'>
                                    </div>
                                    <div class='mb-3'>
                                        <label class='form-label'>Harga Satuan</label>
                                        <input type='decimal' class='form-control' name='unit_price' value='".$data['unit_price']."' placeholder='Masukkan Jumlah'>
                                    </div>
                                    <div class='mb-3'>
                                        <label class='form-label'>Kuantitas</label>
                                        <input type='int' class='form-control' name='quantity' value='".$data['quantity']."' placeholder='Masukkan Jumlah'>
                                    </div>
                                    <div class='mb-3'>
                                        <label class='form-label'>Total</label>
                                        <input type='decimal' class='form-control' name='total' value='".$data['total']."' placeholder='Masukkan Total'>
                                    </div>
                                </div>
                            ...
                            <form method='POST' action='aksi/aksi_pembelian.php'>
                                ...
                                <div class='modal-body'>
                                    <h5> Dengan menghapus data ini anda akan menghapus data dari daftar!<br><br>
                                        <span class='text-danger'>".$data['id_pembelian']."</span>
                                    </h5>
                                </div>
                                <div class='modal-footer'>
    ...
    <div class="modal-body">
        <div class="mb-3">
            <label class="form-label">ID Vendor</label>
            <input type="int" class="form-control" name="id_vendor" placeholder="Masukkan ID Vendor">
        </div>
        <div class="mb-3">
            <label class="form-label">ID Order</label>
            <input type="varchar" class="form-control" name="id_order" placeholder="Masukkan ID Order">
        </div>
        <div class="mb-3">
            <label class="form-label">Harga Satuan</label>
            <input type="decimal" class="form-control" name="unit_price" placeholder="Masukkan Jumlah">
        </div>
        <div class="mb-3">
            <label class="form-label">Kuantitas</label>
            <input type="int" class="form-control" name="quantity" placeholder="Masukkan Jumlah">
        </div>
        <div class="mb-3">
            <label class="form-label">Total</label>
            <input type="decimal" class="form-control" name="total" placeholder="Masukkan Total">
        </div>
    </div>
    <div class="modal-footer">
