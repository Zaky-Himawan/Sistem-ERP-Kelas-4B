...
<html lang="en">
    ...
    <table id="export" class="table table-striped" style="width:100%">
        ...
        <tbody>
            ...
            include "koneksi/koneksi.php";
            $no = 1;
            $tampil = mysqli_query($koneksi, "SELECT * FROM ttransfer ORDER BY id_pengiriman_barang_jadi DESC");
                ...
                <div class='modal fade' id='modalubah".$no."' data-bs-backdrop='static' data-bs-keyboard='false' tabindex='-1' aria-labelledby='staticBackdropLabel' aria-hidden='true'>
                    <div class='modal-dialog'>
                        <div class='modal-content'>
                            ...
                            <form method='POST' action='aksi/aksi_transfer.php'>
                                <input type='hidden' name='id_pengiriman_barang_jadi' value='".$data['id_pengiriman_barang_jadi']."'>
                                <div class='modal-body'>
                                    <div class='mb-3'>
                                        <label class='form-label'>Tanggal Pengiriman</label>
                                        <input type='date' class='form-control' name='ttanggal_pengiriman' value='".$data['tanggal_pengiriman']."' placeholder='Masukkan Tanggal Pengiriman'>
                                    </div>
                                    <div class='mb-3'>
                                        <label class='form-label'>Nama Produk</label>
                                        <input type='text' class='form-control' name='tnama_produk' value='".$data['nama_produk']."' placeholder='Masukkan Nama Produk'>
                                    </div>
                                    <div class='mb-3'>
                                        <label class='form-label'>Jumlah</label>
                                        <input type='number' class='form-control' name='tjumlah' value='".$data['jumlah']."' placeholder='Masukkan Jumlah'>
                                    </div>
                                    <div class='mb-3'>
                                        <label class='form-label'>Gudang Tujuan</label>
                                        <select class='form-select' name='tgudang_tujuan'>
                                            <option value='Gudang A' ".(($data['gudang_tujuan'] == 'Gudang A') ? 'selected' : '').">Gudang A</option>
                                            <option value='Gudang B' ".(($data['gudang_tujuan'] == 'Gudang B') ? 'selected' : '').">Gudang B</option>
                                            <option value='Gudang C' ".(($data['gudang_tujuan'] == 'Gudang C') ? 'selected' : '').">Gudang C</option>
                                        </select>
                                    </div>
                                    <div class='mb-3'>
                                        <label class='form-label'>Status</label>
                                        <select class='form-select' name='tstatus'>
                                            <option value='Sudah Dikirim' ".(($data['status'] == 'Sudah Dikirim') ? 'selected' : '').">Sudah Dikirim</option>
                        ...
                        <div class="modal-content">
                            ...
                            <form method="POST" action="aksi/aksi_transfer.php">
                                <div class="modal-body">
                                    <div class="mb-3">
                                        <label class="form-label">Tanggal Pengiriman</label>
                                        <input type="date" class="form-control" name="ttanggal_pengiriman" placeholder="Masukkan Tanggal Pengiriman">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Nama Produk</label>
                                        <input type="text" class="form-control" name="tnama_produk" placeholder="Masukkan Nama Produk">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Jumlah</label>
                                        <input type="number" class="form-control" name="tjumlah" placeholder="Masukkan Jumlah">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Gudang Tujuan</label>
                                        <select class="form-select" name="tgudang_tujuan">
