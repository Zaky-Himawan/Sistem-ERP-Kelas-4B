...
<html lang="en">
        ...
        <div id="layoutSidenav">
            ...
            <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Purchase Inquiry</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="index.html">Dashboard</a></li>
                            <li class="breadcrumb-item active">Purchase Inquiry</li>
                        </ol>
    ...
    <table id="export" class="table table-striped" style="width:100%">
        <thead>
            <tr>
                <th>No</th>
                <th>ID Request Quotation</th>
                <th>ID Vendor</th>
                <th>Date Purchase Inquiry</th>
                <th>Status</th>
                <th>Aksi</th>
            </tr>
        </thead>
        <tbody>
            ...
            include "koneksi/koneksi.php";
            $no = 1;
            $tampil = mysqli_query($koneksi, "SELECT * FROM purchase_inquiry ORDER BY id_purchase_inquiry DESC");
            while ($data = mysqli_fetch_array($tampil)) {
                echo "<tr>
                <td>".$no."</td>
                <td>".$data['id_request_quotation']."</td>
                <td>".$data['id_vendor']."</td>
                <td>".$data['date_purchase_inquiry']."</td>
                <td>".$data['status']."</td>
                <td>
                ...
                <div class='modal fade' id='modalubah".$no."' data-bs-backdrop='static' data-bs-keyboard='false' tabindex='-1' aria-labelledby='staticBackdropLabel' aria-hidden='true'>
                    <div class='modal-dialog'>
                        <div class='modal-content'>
                            ...
                            <form method='POST' action='aksi/aksi_purchaseinquiry.php'>
                                <input type='hidden' name='id_purchase_inquiry' value='".$data['id_purchase_inquiry']."'>
                                <div class='modal-body'>
                                    <div class='mb-3'>
                                        <label class='form-label'>ID Request Quotation</label>
                                        <input type='number' class='form-control' name='id_request_quotation' value='".$data['id_request_quotation']."' placeholder='Masukkan Tanggal Mulai'>
                                    </div>
                                     <div class='mb-3'>
                                    ...
                                    <div class='mb-3'>
                                        ...
                                        <input type='date' class='form-control' name='date_purchase_inquiry' value='".$data['date_purchase_inquiry']."' placeholder='Masukkan Tanggal Mulai'>
                                    </div>
                                    <div class='mb-3'>
                            ...
                            <form method='POST' action='aksi/aksi_purchaseinquiry.php'>
                                ...
                                <div class='modal-body'>
                                    <h5> Dengan menghapus data ini anda akan menghapus data dari daftar!<br><br>
                                        <span class='text-danger'>".$data['id_purchase_inquiry']."</span>
                                    </h5>
                                </div>
                                <div class='modal-footer'>
                        ...
                        <div class="modal-content">
                            ...
                            <form method="POST" action="aksi/aksi_purchaseinquiry.php">
                                <div class="modal-body">
                                    <div class="mb-3">
                                        <label class="form-label">ID Request Quotation</label>
                                        <input type="number" class="form-control" name="id_request_quotation" placeholder="Masukkan ID Sales Order">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">ID Vendor</label>
                                    ...
                                    <div class="mb-3">
                                        <label class="form-label">Date Purchase Inquiry</label>
                                        <input type="date" class="form-control" name="date_purchase_inquiry" placeholder="Masukkan ID Sales Order">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Status</label>
                                        <select class="form-select" name="status">
