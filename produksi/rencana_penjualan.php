...
<html lang="en">
        ...
        <div id="layoutSidenav">
            ...
            <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Rencana Penjualan</h1>
    ...
    <table id="export" class="table table-striped" style="width:100%">
        ...
        <tbody>
            ...
            include "koneksi/koneksi.php";
            $no = 1;
            $tampil = mysqli_query($koneksi, "SELECT * FROM rencana_penjualan ORDER BY id_rencana DESC");
                ...
                <div class='modal fade' id='modalubah".$no."' data-bs-backdrop='static' data-bs-keyboard='false' tabindex='-1' aria-labelledby='staticBackdropLabel' aria-hidden='true'>
                    <div class='modal-dialog'>
                        <div class='modal-content'>
                            ...
                            <form method='POST' action='aksi/aksi_rencanapenjualan.php'>
                                <input type='hidden' name='id_rencana' value='".$data['id_rencana']."'>
                                <div class='modal-body'>
                                    <div class='mb-3'>
                                        <label class='form-label'>ID Produk</label>
                                        <input type='text' class='form-control' name='id_produk' value='".$data['id_produk']."' placeholder='Masukkan ID rencana'>
                                    </div>
                                    <div class='mb-3'>
                                        <label class='form-label'>Tangga Penjualan</label>
                                        <input type='date' class='form-control' name='tanggal_penjualan' value='".$data['tanggal_penjualan']."' placeholder='Masukkan Tanggal penjualan'>
                                    </div>
                                    <div class='mb-3'>
                                        <label class='form-label'>Tangga Mulai</label>
                            ...
                            <form method='POST' action='aksi/aksi_rencanapenjualan.php'>
                                ...
                                <div class='modal-body'>
                                    <h5> Dengan menghapus data ini anda akan menghapus data dari daftar!<br><br>
                                        <span class='text-danger'>".$data['id_rencana']."</span>
                                    </h5>
                                </div>
                                <div class='modal-footer'>
                            ...
                            <form method="POST" action="aksi/aksi_rencanapenjualan.php">
                                <div class="modal-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="date" class="form-control" name="tanggal_penjualan" placeholder="Masukkan Tanggal penjualan">
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        <label class="form-label">Tanggal Selesai</label>
                                        <input type="date" class="form-control" name="tanggal_selesai" placeholder="Masukkan Tanggal Selesai">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Status</label>
                                        <select class="form-select" name="status">
