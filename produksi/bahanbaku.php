...
<html lang="en">
            ...
            <main>
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            ...
                            <li class="breadcrumb-item active">Penerimaan Bahan Baku</li>
                        </ol>
            
                        <div class="card-body">
    <!-- Tombol modal -->
    <a href="permintaan_bahan_baku.php" class="btn btn-dark mb-3">
        Request Bahan Baku
    </a>
</div>
    ...
    <table id="export" class="table table-striped" style="width:100%">
        ...
        <tbody>
            ...
            include "koneksi/koneksi.php";
            $no = 1;
            $tampil = mysqli_query($koneksi, "SELECT * FROM tpenerimaan ORDER BY id_penerimaan_bahan_baku DESC");
