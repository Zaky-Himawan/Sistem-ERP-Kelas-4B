...
<html lang="en">
        ...
        <div id="layoutSidenav">
            ...
            <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Laporan Biaya Produksi</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="index.html">Dashboard</a></li>
                            <li class="breadcrumb-item active">Laporan Biaya Produksi</li>
                        </ol>
    ...
    <table id="export" class="table table-striped" style="width:100%">
        ...
        <tbody>
            ...
            include "koneksi/koneksi.php";
            $no = 1;
            $tampil = mysqli_query($koneksi, "SELECT * FROM tbiaya ORDER BY id_laporan_biaya DESC");
            while ($data = mysqli_fetch_array($tampil)) {
                echo "<tr>
                <td>".$no."</td>
                <td>".$data['tanggal']."</td>
                <td>".$data['biaya_bahanbaku']."</td>
                <td>".$data['biaya_overhead_produksi']."</td>
                <td>".$data['biaya_tenaga_kerja']."</td>
                <td>
                ...
                <div class='modal fade' id='modalubah".$no."' data-bs-backdrop='static' data-bs-keyboard='false' tabindex='-1' aria-labelledby='staticBackdropLabel' aria-hidden='true'>
                    <div class='modal-dialog'>
                        <div class='modal-content'>
                            ...
                            <form method='POST' action='aksi/aksi_laporanbiaya.php'>
                                <input type='hidden' name='id_laporan_biaya' value='".$data['id_laporan_biaya']."'>
                                <div class='modal-body'>
                                    <div class='mb-3'>
                                        <label class='form-label'>Tanggal</label>
                                        <input type='date' class='form-control' name='ttanggal' value='".$data['tanggal']."' placeholder='Masukkan Tanggal Laporan'>
                                    </div>
                                    <div class='mb-3'>
                                        <label class='form-label'>Biaya Bahan Baku</label>
                                        <input type='number' class='form-control' name='tbiaya_bahanbaku' value='".$data['biaya_bahanbaku']."' placeholder='Masukkan Biaya Bahan Baku'>
                                    </div>
                                    <div class='mb-3'>
                                        <label class='form-label'>Biaya Overhead Produksi</label>
                                        <input type='number' class='form-control' name='tbiaya_overhead_produksi' value='".$data['biaya_overhead_produksi']."' placeholder='Masukkan Biaya Overhead Produksi'>
                                    </div>
                                    <div class='mb-3'>
                                        <label class='form-label'>Jumlah</label>
                                        <input type='number' class='form-control' name='tbiaya_tenaga_kerja' value='".$data['biaya_tenaga_kerja']."' placeholder='Masukkan Biaya Tenaga Kerja'>
                                    </div>
                                </div>
                        ...
                        <div class="modal-content">
                            ...
                            <form method="POST" action="aksi/aksi_laporanbiaya.php">
                                <div class="modal-body">
                                    <div class="mb-3">
                                        <label class="form-label">Tanggal</label>
                                        <input type="date" class="form-control" name="ttanggal" placeholder="Masukkan Tanggal">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Biaya Bahan Baku</label>
                                        <input type="number" class="form-control" name="tbiaya_bahanbaku" placeholder="Masukkan Biaya Bahan Baku">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Biaya Overhead Produksi</label>
                                        <input type="number" class="form-control" name="tbiaya_overhead_produksi" placeholder="Masukkan Biaya Overhead Produksi">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Biaya Tenaga Kerja</label>
                                        <input type="number" class="form-control" name="tbiaya_tenaga_kerja" placeholder="Masukkan Biaya Tenaga Kerja">
                                    </div>
                                </div>
                                <div class="modal-footer">
