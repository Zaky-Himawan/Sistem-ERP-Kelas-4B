...
<html lang="en">
        ...
        <div id="layoutSidenav">
            ...
            <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Produksi Marketing</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="index.html">Dashboard</a></li>
                            <li class="breadcrumb-item active">Produksi Marketing</li>
                        </ol>
    ...
    <table id="export" class="table table-striped" style="width:100%">
        ...
        <tbody>
            ...
            include "koneksi/koneksi.php";
            $no = 1;
            $tampil = mysqli_query($koneksi, "SELECT * FROM produksi_marketing ORDER BY id_produk DESC");
            while ($data = mysqli_fetch_array($tampil)) {
                echo "<tr>
                <td>".$no."</td>
                <td>".$data['nama_produk']."</td>
                <td>".$data['harga_price']."</td>
                <td>".$data['biaya_produksi']."</td>
                <td>".$data['category']."</td>
                <td>".$data['stock']."</td>
                <td>
                ...
                <div class='modal fade' id='modalubah".$no."' data-bs-backdrop='static' data-bs-keyboard='false' tabindex='-1' aria-labelledby='staticBackdropLabel' aria-hidden='true'>
                    <div class='modal-dialog'>
                        <div class='modal-content'>
                            ...
                            <form method='POST' action='aksi/aksi_produksimarketing.php'>
                                ...
                                <div class='modal-body'>
                                    ...
                                    <div class='mb-3'>
                                        ...
                                        <input type='number' class='form-control' name='harga_price' value='".$data['harga_price']."' placeholder='Masukkan Harga'>
                                    </div>
                                    <div class='mb-3'>
                                        <label class='form-label'>Biaya Produksi</label>
                                        <input type='number' class='form-control' name='biaya_produksi' value='".$data['biaya_produksi']."' placeholder='Masukkan biaya produksi'>
                                    </div>
                                    <div class='mb-3'>
                                        <label class='form-label'>Kategori</label>
                                        <input type='text' class='form-control' name='category' value='".$data['category']."' placeholder='Masukkan Kategori'>
                                    </div>
                                    <div class='mb-3'>
                                        <label class='form-label'>Stok</label>
                                        <input type='text' class='form-control' name='stock' value='".$data['stock']."' placeholder='Masukkan Stok'>
                                    </div>
                                </div>
                            ...
                            <form method='POST' action='aksi/aksi_produksimarketing.php'>
                                ...
                                <div class='modal-body'>
                                    <h5> Dengan menghapus data ini anda akan menghapus data dari daftar!<br><br>
                                        <span class='text-danger'>".$data['id_produk']."</span>
                                    </h5>
                                </div>
                                <div class='modal-footer'>
                        ...
                        <div class="modal-content">
                            ...
                            <form method="POST" action="aksi/aksi_produksimarketing.php">
                                <div class="modal-body">
                                    ...
                                    <div class="mb-3">
                                        <label class="form-label">Harga</label>
                                        <input type="number" class="form-control" name="harga_price" placeholder="Masukkan harga">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Biaya Produksi</label>
                                        <input type="number" class="form-control" name="biaya_produksi" placeholder="Masukkan biaya Produksi">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Kategori</label>
