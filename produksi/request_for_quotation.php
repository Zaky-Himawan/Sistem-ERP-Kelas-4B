...
<html lang="en">
        ...
        <div id="layoutSidenav">
            ...
            <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Request For Quotation</h1>
    ...
    <table id="export" class="table table-striped" style="width:100%">
        ...
        <tbody>
            ...
            include "koneksi/koneksi.php";
            $no = 1;
            $tampil = mysqli_query($koneksi, "SELECT * FROM request_for_quotation ORDER BY id_rfq DESC");
            while ($data = mysqli_fetch_array($tampil)) {
                echo "<tr>
                <td>".$no."</td>
                <td>".$data['id_purchase_requisition']."</td>
                ...
                <div class='modal fade' id='modalubah".$no."' data-bs-backdrop='static' data-bs-keyboard='false' tabindex='-1' aria-labelledby='staticBackdropLabel' aria-hidden='true'>
                    <div class='modal-dialog'>
                        <div class='modal-content'>
                            ...
                            <form method='POST' action='aksi/aksi_requestforquotation.php'>
                                <input type='hidden' name='id_rfq' value='".$data['id_rfq']."'>
                                <div class='modal-body'>
                                    <div class='mb-3'>
                                        <label class='form-label'>ID Purchase</label>
                                        <input type='number' class='form-control' name='id_purchase_requisition' value='".$data['id_purchase_requisition']."' placeholder='Masukkan Nama Produk'>
                                    </div>
                                     <div class='mb-3'>
                                    ...
                                    <div class='mb-3'>
                                        <label class='form-label'>Date RFQ</label>
                                        <input type='date' class='form-control' name='date_rfq' value='".$data['date_rfq']."' placeholder='Masukkan Tanggal'>
                                    </div>
                                    <div class='mb-3'>
                                        <label class='form-label'>List Of Material</label>
                                        <input type='text' class='form-control' name='list_of_material' value='".$data['list_of_material']."' placeholder='Masukkan Nama Produk'>
                                    </div>
                                    <div class='mb-3'>
                                        <label class='form-label'>Total Price</label>
                                        <input type='number' class='form-control' name='total_price' value='".$data['total_price']."' placeholder='Masukkan Jumlah'>
                                    </div>
                                    <div class='mb-3'>
                                        <label class='form-label'>Tanggal Batas</label>
                                        <input type='date' class='form-control' name='valid_until' value='".$data['valid_until']."' placeholder='Masukkan Harga Jual  Produk'>
                                    </div>
                                    <div class='mb-3'>
                            ...
                            <form method='POST' action='aksi/aksi_requestforquotation.php'>
                                ...
                                <div class='modal-body'>
                                    <h5> Dengan menghapus data ini anda akan menghapus data dari daftar!<br><br>
                                        <span class='text-danger'>".$data['id_rfq']."</span>
                                    </h5>
                                </div>
                                <div class='modal-footer'>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <form method="POST" action="aksi/aksi_requestforquotation.php">
                                <div class="modal-body">
                                    <div class="mb-3">
                                        <label class="form-label">ID Purchase Requisition</label>
                                        <input type="number" class="form-control" name="id_purchase_requisition" placeholder="Masukkan Nama Produk">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">ID Vendor</label>
                                        <input type="number" class="form-control" name="id_vendor" placeholder="Masukkan Nama Produk">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Date RFQ</label>
                                        <input type="date" class="form-control" name="date_rfq" placeholder="Masukkan Tanggal">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">List Of Material</label>
                                        <input type="text" class="form-control" name="list_of_material" placeholder="Masukkan Nama Produk">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Total Price</label>
                                        <input type="number" class="form-control" name="total_price" placeholder="Masukkan Jumlah">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Tanggal Batas</label>
                                        <input type="date" class="form-control" name="valid_until" placeholder="Masukkan Harga Jual">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Status</label>
                                        <select class="form-select" name="status">
